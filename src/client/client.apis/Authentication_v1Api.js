...
* @module client/client.apis/Authentication_v1Api
* @version 0.1
*/
export default class Authentication_v1Api {
    ...
    * @alias module:client/client.apis/Authentication_v1Api
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/Authentication_v1Api~createTokenReviewCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1TokenReview} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * create a TokenReview
     * @param {module:client/client.models/V1TokenReview} body 
     ...
     * @param {module:client/client.apis/Authentication_v1Api~createTokenReviewCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1TokenReview}
     */
     ...
     * @callback module:client/client.apis/Authentication_v1Api~getAPIResourcesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:client/client.apis/Authentication_v1Api~getAPIResourcesCallback} callback The callback function, accepting three arguments: error, data, response

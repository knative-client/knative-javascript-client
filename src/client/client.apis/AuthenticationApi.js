...
* @module client/client.apis/AuthenticationApi
* @version 0.1
*/
export default class AuthenticationApi {
    ...
    * @alias module:client/client.apis/AuthenticationApi
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/AuthenticationApi~getAPIGroupCallback
     ...
     * @param {module:client/client.apis/AuthenticationApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

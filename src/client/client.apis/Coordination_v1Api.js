...
/**
* Coordination_v1 service.
* @module client/client.apis/Coordination_v1Api
* @version 0.1
*/
export default class Coordination_v1Api {

    /**
    * Constructs a new Coordination_v1Api. 
    * @alias module:client/client.apis/Coordination_v1Api
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/Coordination_v1Api~createNamespacedLeaseCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1Lease} data The data returned by the service call.
     ...
     * @param {module:client/client.models/V1Lease} body 
     ...
     * @param {module:client/client.apis/Coordination_v1Api~createNamespacedLeaseCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1Lease}
     */
     ...
     * @callback module:client/client.apis/Coordination_v1Api~deleteCollectionNamespacedLeaseCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:client/client.apis/Coordination_v1Api~deleteCollectionNamespacedLeaseCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:client/client.apis/Coordination_v1Api~deleteNamespacedLeaseCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1Status} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:client/client.apis/Coordination_v1Api~deleteNamespacedLeaseCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1Status}
     */
     ...
     * @callback module:client/client.apis/Coordination_v1Api~getAPIResourcesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:client/client.apis/Coordination_v1Api~getAPIResourcesCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:client/client.apis/Coordination_v1Api~listLeaseForAllNamespacesCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1LeaseList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.timeoutSeconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
     * @param {Boolean} opts.watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:client/client.apis/Coordination_v1Api~listLeaseForAllNamespacesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1LeaseList}
     */
     ...
     * @callback module:client/client.apis/Coordination_v1Api~listNamespacedLeaseCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1LeaseList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.timeoutSeconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
     * @param {Boolean} opts.watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:client/client.apis/Coordination_v1Api~listNamespacedLeaseCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1LeaseList}
     */
     ...
     * @callback module:client/client.apis/Coordination_v1Api~patchNamespacedLeaseCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1Lease} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:client/client.apis/Coordination_v1Api~patchNamespacedLeaseCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1Lease}
     */
     ...
     * @callback module:client/client.apis/Coordination_v1Api~readNamespacedLeaseCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1Lease} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:client/client.apis/Coordination_v1Api~readNamespacedLeaseCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1Lease}
     */
     ...
     * @callback module:client/client.apis/Coordination_v1Api~replaceNamespacedLeaseCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1Lease} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
     * @param {String} opts.fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     * @param {module:client/client.apis/Coordination_v1Api~replaceNamespacedLeaseCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1Lease}
     */

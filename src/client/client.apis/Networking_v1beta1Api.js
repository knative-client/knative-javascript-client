...
/**
* Networking_v1beta1 service.
* @module client/client.apis/Networking_v1beta1Api
* @version 0.1
*/
export default class Networking_v1beta1Api {

    /**
    * Constructs a new Networking_v1beta1Api. 
    * @alias module:client/client.apis/Networking_v1beta1Api
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/Networking_v1beta1Api~createNamespacedIngressCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/NetworkingV1beta1Ingress} data The data returned by the service call.
     ...
     * @param {module:client/client.models/NetworkingV1beta1Ingress} body 
     ...
     * @param {module:client/client.apis/Networking_v1beta1Api~createNamespacedIngressCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/NetworkingV1beta1Ingress}
     */
    createNamespacedIngress(namespace, body, opts, callback) {
      ...
      let returnType = NetworkingV1beta1Ingress;

      return this.apiClient.callApi(
        '/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses', 'POST',
     ...
     * @callback module:client/client.apis/Networking_v1beta1Api~deleteCollectionNamespacedIngressCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:client/client.apis/Networking_v1beta1Api~deleteCollectionNamespacedIngressCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    deleteCollectionNamespacedIngress(namespace, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
     ...
     * @callback module:client/client.apis/Networking_v1beta1Api~deleteNamespacedIngressCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1Status} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:client/client.apis/Networking_v1beta1Api~deleteNamespacedIngressCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1Status}
     */
    deleteNamespacedIngress(name, namespace, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
     ...
     * @callback module:client/client.apis/Networking_v1beta1Api~getAPIResourcesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:client/client.apis/Networking_v1beta1Api~getAPIResourcesCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:client/client.apis/Networking_v1beta1Api~listIngressForAllNamespacesCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/NetworkingV1beta1IngressList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.timeoutSeconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
     * @param {Boolean} opts.watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:client/client.apis/Networking_v1beta1Api~listIngressForAllNamespacesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/NetworkingV1beta1IngressList}
     */
    listIngressForAllNamespaces(opts, callback) {
      ...
      let returnType = NetworkingV1beta1IngressList;
     ...
     * @callback module:client/client.apis/Networking_v1beta1Api~listNamespacedIngressCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/NetworkingV1beta1IngressList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.timeoutSeconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
     * @param {Boolean} opts.watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:client/client.apis/Networking_v1beta1Api~listNamespacedIngressCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/NetworkingV1beta1IngressList}
     */
    listNamespacedIngress(namespace, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
     ...
     * @callback module:client/client.apis/Networking_v1beta1Api~patchNamespacedIngressCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/NetworkingV1beta1Ingress} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:client/client.apis/Networking_v1beta1Api~patchNamespacedIngressCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/NetworkingV1beta1Ingress}
     */
    patchNamespacedIngress(name, namespace, body, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
     ...
     * @callback module:client/client.apis/Networking_v1beta1Api~patchNamespacedIngressStatusCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/NetworkingV1beta1Ingress} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. This field is required for apply requests (application/apply-patch) but optional for non-apply patch types (JsonPatch, MergePatch, StrategicMergePatch).
     * @param {Boolean} opts.force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
     * @param {module:client/client.apis/Networking_v1beta1Api~patchNamespacedIngressStatusCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/NetworkingV1beta1Ingress}
     */
    patchNamespacedIngressStatus(name, namespace, body, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}/status', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
     ...
     * @callback module:client/client.apis/Networking_v1beta1Api~readNamespacedIngressCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/NetworkingV1beta1Ingress} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:client/client.apis/Networking_v1beta1Api~readNamespacedIngressCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/NetworkingV1beta1Ingress}
     */
    readNamespacedIngress(name, namespace, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
     ...
     * @callback module:client/client.apis/Networking_v1beta1Api~readNamespacedIngressStatusCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/NetworkingV1beta1Ingress} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.pretty If &#39;true&#39;, then the output is pretty printed.
     * @param {module:client/client.apis/Networking_v1beta1Api~readNamespacedIngressStatusCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/NetworkingV1beta1Ingress}
     */
     ...
     * @callback module:client/client.apis/Networking_v1beta1Api~replaceNamespacedIngressCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/NetworkingV1beta1Ingress} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
     * @param {String} opts.fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     * @param {module:client/client.apis/Networking_v1beta1Api~replaceNamespacedIngressCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/NetworkingV1beta1Ingress}
     */
    replaceNamespacedIngress(name, namespace, body, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
     ...
     * @callback module:client/client.apis/Networking_v1beta1Api~replaceNamespacedIngressStatusCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/NetworkingV1beta1Ingress} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
     * @param {String} opts.fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     * @param {module:client/client.apis/Networking_v1beta1Api~replaceNamespacedIngressStatusCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/NetworkingV1beta1Ingress}
     */
    replaceNamespacedIngressStatus(name, namespace, body, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}/status', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }

...
* @module client/client.apis/CoordinationApi
* @version 0.1
*/
export default class CoordinationApi {

    /**
    * Constructs a new CoordinationApi. 
    * @alias module:client/client.apis/CoordinationApi
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/CoordinationApi~getAPIGroupCallback
     ...
     * @param {module:client/client.apis/CoordinationApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

...
/**
* Node service.
* @module client/client.apis/NodeApi
* @version 0.1
*/
export default class NodeApi {
    ...
    * @alias module:client/client.apis/NodeApi
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/NodeApi~getAPIGroupCallback
     ...
     * @param {module:client/client.apis/NodeApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

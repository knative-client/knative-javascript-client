...
/**
* Extensions service.
* @module client/client.apis/ExtensionsApi
* @version 0.1
*/
export default class ExtensionsApi {
    ...
    * @alias module:client/client.apis/ExtensionsApi
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/ExtensionsApi~getAPIGroupCallback
     ...
     * @param {module:client/client.apis/ExtensionsApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

...
/**
* Batch_v1beta1 service.
* @module client/client.apis/Batch_v1beta1Api
* @version 0.1
*/
export default class Batch_v1beta1Api {

    /**
    * Constructs a new Batch_v1beta1Api. 
    * @alias module:client/client.apis/Batch_v1beta1Api
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/Batch_v1beta1Api~createNamespacedCronJobCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1beta1CronJob} data The data returned by the service call.
     ...
     * @param {module:client/client.models/V1beta1CronJob} body 
     ...
     * @param {module:client/client.apis/Batch_v1beta1Api~createNamespacedCronJobCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1beta1CronJob}
     */
     ...
     * @callback module:client/client.apis/Batch_v1beta1Api~deleteCollectionNamespacedCronJobCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:client/client.apis/Batch_v1beta1Api~deleteCollectionNamespacedCronJobCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:client/client.apis/Batch_v1beta1Api~deleteNamespacedCronJobCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1Status} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:client/client.apis/Batch_v1beta1Api~deleteNamespacedCronJobCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1Status}
     */
    deleteNamespacedCronJob(name, namespace, opts, callback) {
      opts = opts || {};
     ...
     * @callback module:client/client.apis/Batch_v1beta1Api~getAPIResourcesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:client/client.apis/Batch_v1beta1Api~getAPIResourcesCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:client/client.apis/Batch_v1beta1Api~listCronJobForAllNamespacesCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1beta1CronJobList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.timeoutSeconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
     * @param {Boolean} opts.watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:client/client.apis/Batch_v1beta1Api~listCronJobForAllNamespacesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1beta1CronJobList}
     */
    listCronJobForAllNamespaces(opts, callback) {
      ...
      let returnType = V1beta1CronJobList;
     ...
     * @callback module:client/client.apis/Batch_v1beta1Api~listNamespacedCronJobCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1beta1CronJobList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.timeoutSeconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
     * @param {Boolean} opts.watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:client/client.apis/Batch_v1beta1Api~listNamespacedCronJobCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1beta1CronJobList}
     */
     ...
     * @callback module:client/client.apis/Batch_v1beta1Api~patchNamespacedCronJobCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1beta1CronJob} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:client/client.apis/Batch_v1beta1Api~patchNamespacedCronJobCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1beta1CronJob}
     */
     ...
     * @callback module:client/client.apis/Batch_v1beta1Api~patchNamespacedCronJobStatusCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1beta1CronJob} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. This field is required for apply requests (application/apply-patch) but optional for non-apply patch types (JsonPatch, MergePatch, StrategicMergePatch).
     * @param {Boolean} opts.force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
     * @param {module:client/client.apis/Batch_v1beta1Api~patchNamespacedCronJobStatusCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1beta1CronJob}
     */
     ...
     * @callback module:client/client.apis/Batch_v1beta1Api~readNamespacedCronJobCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1beta1CronJob} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:client/client.apis/Batch_v1beta1Api~readNamespacedCronJobCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1beta1CronJob}
     */
     ...
     * @callback module:client/client.apis/Batch_v1beta1Api~readNamespacedCronJobStatusCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1beta1CronJob} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.pretty If &#39;true&#39;, then the output is pretty printed.
     * @param {module:client/client.apis/Batch_v1beta1Api~readNamespacedCronJobStatusCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1beta1CronJob}
     */
     ...
     * @callback module:client/client.apis/Batch_v1beta1Api~replaceNamespacedCronJobCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1beta1CronJob} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
     * @param {String} opts.fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     * @param {module:client/client.apis/Batch_v1beta1Api~replaceNamespacedCronJobCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1beta1CronJob}
     */
     ...
     * @callback module:client/client.apis/Batch_v1beta1Api~replaceNamespacedCronJobStatusCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1beta1CronJob} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
     * @param {String} opts.fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     * @param {module:client/client.apis/Batch_v1beta1Api~replaceNamespacedCronJobStatusCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1beta1CronJob}
     */

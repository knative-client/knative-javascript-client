...
/**
* Events service.
* @module client/client.apis/EventsApi
* @version 0.1
*/
export default class EventsApi {
    ...
    * @alias module:client/client.apis/EventsApi
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/EventsApi~getAPIGroupCallback
     ...
     * @param {module:client/client.apis/EventsApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

...
/**
* Batch service.
* @module client/client.apis/BatchApi
* @version 0.1
*/
export default class BatchApi {
    ...
    * @alias module:client/client.apis/BatchApi
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/BatchApi~getAPIGroupCallback
     ...
     * @param {module:client/client.apis/BatchApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

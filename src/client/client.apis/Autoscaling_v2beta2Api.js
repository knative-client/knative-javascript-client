...
/**
* Autoscaling_v2beta2 service.
* @module client/client.apis/Autoscaling_v2beta2Api
* @version 0.1
*/
export default class Autoscaling_v2beta2Api {

    /**
    * Constructs a new Autoscaling_v2beta2Api. 
    * @alias module:client/client.apis/Autoscaling_v2beta2Api
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/Autoscaling_v2beta2Api~createNamespacedHorizontalPodAutoscalerCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V2beta2HorizontalPodAutoscaler} data The data returned by the service call.
     ...
     * @param {module:client/client.models/V2beta2HorizontalPodAutoscaler} body 
     ...
     * @param {module:client/client.apis/Autoscaling_v2beta2Api~createNamespacedHorizontalPodAutoscalerCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V2beta2HorizontalPodAutoscaler}
     */
    createNamespacedHorizontalPodAutoscaler(namespace, body, opts, callback) {
      ...
      let returnType = V2beta2HorizontalPodAutoscaler;
     ...
     * @callback module:client/client.apis/Autoscaling_v2beta2Api~deleteCollectionNamespacedHorizontalPodAutoscalerCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:client/client.apis/Autoscaling_v2beta2Api~deleteCollectionNamespacedHorizontalPodAutoscalerCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:client/client.apis/Autoscaling_v2beta2Api~deleteNamespacedHorizontalPodAutoscalerCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1Status} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:client/client.apis/Autoscaling_v2beta2Api~deleteNamespacedHorizontalPodAutoscalerCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1Status}
     */
    deleteNamespacedHorizontalPodAutoscaler(name, namespace, opts, callback) {
      opts = opts || {};
     ...
     * @callback module:client/client.apis/Autoscaling_v2beta2Api~getAPIResourcesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:client/client.apis/Autoscaling_v2beta2Api~getAPIResourcesCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:client/client.apis/Autoscaling_v2beta2Api~listHorizontalPodAutoscalerForAllNamespacesCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V2beta2HorizontalPodAutoscalerList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.timeoutSeconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
     * @param {Boolean} opts.watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:client/client.apis/Autoscaling_v2beta2Api~listHorizontalPodAutoscalerForAllNamespacesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V2beta2HorizontalPodAutoscalerList}
     */
    listHorizontalPodAutoscalerForAllNamespaces(opts, callback) {
      ...
      let returnType = V2beta2HorizontalPodAutoscalerList;
     ...
     * @callback module:client/client.apis/Autoscaling_v2beta2Api~listNamespacedHorizontalPodAutoscalerCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V2beta2HorizontalPodAutoscalerList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.timeoutSeconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
     * @param {Boolean} opts.watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:client/client.apis/Autoscaling_v2beta2Api~listNamespacedHorizontalPodAutoscalerCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V2beta2HorizontalPodAutoscalerList}
     */
     ...
     * @callback module:client/client.apis/Autoscaling_v2beta2Api~patchNamespacedHorizontalPodAutoscalerCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V2beta2HorizontalPodAutoscaler} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:client/client.apis/Autoscaling_v2beta2Api~patchNamespacedHorizontalPodAutoscalerCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V2beta2HorizontalPodAutoscaler}
     */
     ...
     * @callback module:client/client.apis/Autoscaling_v2beta2Api~patchNamespacedHorizontalPodAutoscalerStatusCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V2beta2HorizontalPodAutoscaler} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. This field is required for apply requests (application/apply-patch) but optional for non-apply patch types (JsonPatch, MergePatch, StrategicMergePatch).
     * @param {Boolean} opts.force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
     * @param {module:client/client.apis/Autoscaling_v2beta2Api~patchNamespacedHorizontalPodAutoscalerStatusCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V2beta2HorizontalPodAutoscaler}
     */
     ...
     * @callback module:client/client.apis/Autoscaling_v2beta2Api~readNamespacedHorizontalPodAutoscalerCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V2beta2HorizontalPodAutoscaler} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:client/client.apis/Autoscaling_v2beta2Api~readNamespacedHorizontalPodAutoscalerCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V2beta2HorizontalPodAutoscaler}
     */
     ...
     * @callback module:client/client.apis/Autoscaling_v2beta2Api~readNamespacedHorizontalPodAutoscalerStatusCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V2beta2HorizontalPodAutoscaler} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.pretty If &#39;true&#39;, then the output is pretty printed.
     * @param {module:client/client.apis/Autoscaling_v2beta2Api~readNamespacedHorizontalPodAutoscalerStatusCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V2beta2HorizontalPodAutoscaler}
     */
     ...
     * @callback module:client/client.apis/Autoscaling_v2beta2Api~replaceNamespacedHorizontalPodAutoscalerCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V2beta2HorizontalPodAutoscaler} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
     * @param {String} opts.fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     * @param {module:client/client.apis/Autoscaling_v2beta2Api~replaceNamespacedHorizontalPodAutoscalerCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V2beta2HorizontalPodAutoscaler}
     */
     ...
     * @callback module:client/client.apis/Autoscaling_v2beta2Api~replaceNamespacedHorizontalPodAutoscalerStatusCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V2beta2HorizontalPodAutoscaler} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
     * @param {String} opts.fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     * @param {module:client/client.apis/Autoscaling_v2beta2Api~replaceNamespacedHorizontalPodAutoscalerStatusCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V2beta2HorizontalPodAutoscaler}
     */

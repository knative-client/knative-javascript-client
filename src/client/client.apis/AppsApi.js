...
/**
* Apps service.
* @module client/client.apis/AppsApi
* @version 0.1
*/
export default class AppsApi {
    ...
    * @alias module:client/client.apis/AppsApi
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/AppsApi~getAPIGroupCallback
     ...
     * @param {module:client/client.apis/AppsApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

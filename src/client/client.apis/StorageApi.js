...
/**
* Storage service.
* @module client/client.apis/StorageApi
* @version 0.1
*/
export default class StorageApi {
    ...
    * @alias module:client/client.apis/StorageApi
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/StorageApi~getAPIGroupCallback
     ...
     * @param {module:client/client.apis/StorageApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

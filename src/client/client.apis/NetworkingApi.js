...
/**
* Networking service.
* @module client/client.apis/NetworkingApi
* @version 0.1
*/
export default class NetworkingApi {
    ...
    * @alias module:client/client.apis/NetworkingApi
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/NetworkingApi~getAPIGroupCallback
     ...
     * @param {module:client/client.apis/NetworkingApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

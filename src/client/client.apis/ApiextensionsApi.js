...
* @module client/client.apis/ApiextensionsApi
* @version 0.1
*/
export default class ApiextensionsApi {

    /**
    * Constructs a new ApiextensionsApi. 
    * @alias module:client/client.apis/ApiextensionsApi
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/ApiextensionsApi~getAPIGroupCallback
     ...
     * @param {module:client/client.apis/ApiextensionsApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

...
/**
* Admissionregistration service.
* @module client/client.apis/AdmissionregistrationApi
* @version 0.1
*/
export default class AdmissionregistrationApi {

    /**
    * Constructs a new AdmissionregistrationApi. 
    * @alias module:client/client.apis/AdmissionregistrationApi
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/AdmissionregistrationApi~getAPIGroupCallback
     ...
     * @param {module:client/client.apis/AdmissionregistrationApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

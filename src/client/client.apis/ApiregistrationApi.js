...
/**
* Apiregistration service.
* @module client/client.apis/ApiregistrationApi
* @version 0.1
*/
export default class ApiregistrationApi {

    /**
    * Constructs a new ApiregistrationApi. 
    * @alias module:client/client.apis/ApiregistrationApi
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/ApiregistrationApi~getAPIGroupCallback
     ...
     * @param {module:client/client.apis/ApiregistrationApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

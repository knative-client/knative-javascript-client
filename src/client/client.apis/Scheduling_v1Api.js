...
/**
* Scheduling_v1 service.
* @module client/client.apis/Scheduling_v1Api
* @version 0.1
*/
export default class Scheduling_v1Api {

    /**
    * Constructs a new Scheduling_v1Api. 
    * @alias module:client/client.apis/Scheduling_v1Api
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/Scheduling_v1Api~createPriorityClassCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1PriorityClass} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * create a PriorityClass
     * @param {module:client/client.models/V1PriorityClass} body 
     ...
     * @param {module:client/client.apis/Scheduling_v1Api~createPriorityClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1PriorityClass}
     */
    createPriorityClass(body, opts, callback) {
      ...
      let returnType = V1PriorityClass;
     ...
     * @callback module:client/client.apis/Scheduling_v1Api~deleteCollectionPriorityClassCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:client/client.apis/Scheduling_v1Api~deleteCollectionPriorityClassCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:client/client.apis/Scheduling_v1Api~deletePriorityClassCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1Status} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:client/client.apis/Scheduling_v1Api~deletePriorityClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1Status}
     */
     ...
     * @callback module:client/client.apis/Scheduling_v1Api~getAPIResourcesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:client/client.apis/Scheduling_v1Api~getAPIResourcesCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:client/client.apis/Scheduling_v1Api~listPriorityClassCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1PriorityClassList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.timeoutSeconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
     * @param {Boolean} opts.watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:client/client.apis/Scheduling_v1Api~listPriorityClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1PriorityClassList}
     */
    listPriorityClass(opts, callback) {
      ...
      let returnType = V1PriorityClassList;
     ...
     * @callback module:client/client.apis/Scheduling_v1Api~patchPriorityClassCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1PriorityClass} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:client/client.apis/Scheduling_v1Api~patchPriorityClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1PriorityClass}
     */
     ...
     * @callback module:client/client.apis/Scheduling_v1Api~readPriorityClassCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1PriorityClass} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:client/client.apis/Scheduling_v1Api~readPriorityClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1PriorityClass}
     */
     ...
     * @callback module:client/client.apis/Scheduling_v1Api~replacePriorityClassCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1PriorityClass} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
     * @param {String} opts.fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     * @param {module:client/client.apis/Scheduling_v1Api~replacePriorityClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1PriorityClass}
     */

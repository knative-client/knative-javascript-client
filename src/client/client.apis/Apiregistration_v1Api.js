...
* @module client/client.apis/Apiregistration_v1Api
* @version 0.1
*/
export default class Apiregistration_v1Api {
    ...
    * @alias module:client/client.apis/Apiregistration_v1Api
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/Apiregistration_v1Api~createAPIServiceCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1APIService} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * create an APIService
     * @param {module:client/client.models/V1APIService} body 
     ...
     * @param {module:client/client.apis/Apiregistration_v1Api~createAPIServiceCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1APIService}
     */
     ...
     * @callback module:client/client.apis/Apiregistration_v1Api~deleteAPIServiceCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:client/client.apis/Apiregistration_v1Api~deleteAPIServiceCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:client/client.apis/Apiregistration_v1Api~deleteCollectionAPIServiceCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1Status} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:client/client.apis/Apiregistration_v1Api~deleteCollectionAPIServiceCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1Status}
     */
     ...
     * @callback module:client/client.apis/Apiregistration_v1Api~getAPIResourcesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:client/client.apis/Apiregistration_v1Api~getAPIResourcesCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:client/client.apis/Apiregistration_v1Api~listAPIServiceCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1APIServiceList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.timeoutSeconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
     * @param {Boolean} opts.watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:client/client.apis/Apiregistration_v1Api~listAPIServiceCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1APIServiceList}
     */
     ...
     * @callback module:client/client.apis/Apiregistration_v1Api~patchAPIServiceCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1APIService} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:client/client.apis/Apiregistration_v1Api~patchAPIServiceCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1APIService}
     */
     ...
     * @callback module:client/client.apis/Apiregistration_v1Api~patchAPIServiceStatusCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1APIService} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. This field is required for apply requests (application/apply-patch) but optional for non-apply patch types (JsonPatch, MergePatch, StrategicMergePatch).
     * @param {Boolean} opts.force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
     * @param {module:client/client.apis/Apiregistration_v1Api~patchAPIServiceStatusCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1APIService}
     */
     ...
     * @callback module:client/client.apis/Apiregistration_v1Api~readAPIServiceCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1APIService} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:client/client.apis/Apiregistration_v1Api~readAPIServiceCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1APIService}
     */
     ...
     * @callback module:client/client.apis/Apiregistration_v1Api~readAPIServiceStatusCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1APIService} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.pretty If &#39;true&#39;, then the output is pretty printed.
     * @param {module:client/client.apis/Apiregistration_v1Api~readAPIServiceStatusCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1APIService}
     */
     ...
     * @callback module:client/client.apis/Apiregistration_v1Api~replaceAPIServiceCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1APIService} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
     * @param {String} opts.fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     * @param {module:client/client.apis/Apiregistration_v1Api~replaceAPIServiceCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1APIService}
     */
     ...
     * @callback module:client/client.apis/Apiregistration_v1Api~replaceAPIServiceStatusCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1APIService} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
     * @param {String} opts.fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     * @param {module:client/client.apis/Apiregistration_v1Api~replaceAPIServiceStatusCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1APIService}
     */

...
* @module client/client.apis/RbacAuthorizationApi
* @version 0.1
*/
export default class RbacAuthorizationApi {
    ...
    * @alias module:client/client.apis/RbacAuthorizationApi
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/RbacAuthorizationApi~getAPIGroupCallback
     ...
     * @param {module:client/client.apis/RbacAuthorizationApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

...
* @module client/client.apis/AuthorizationApi
* @version 0.1
*/
export default class AuthorizationApi {
    ...
    * @alias module:client/client.apis/AuthorizationApi
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/AuthorizationApi~getAPIGroupCallback
     ...
     * @param {module:client/client.apis/AuthorizationApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

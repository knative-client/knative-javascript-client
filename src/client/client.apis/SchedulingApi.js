...
/**
* Scheduling service.
* @module client/client.apis/SchedulingApi
* @version 0.1
*/
export default class SchedulingApi {

    /**
    * Constructs a new SchedulingApi. 
    * @alias module:client/client.apis/SchedulingApi
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/SchedulingApi~getAPIGroupCallback
     ...
     * @param {module:client/client.apis/SchedulingApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

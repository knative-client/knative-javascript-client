...
/**
* Policy service.
* @module client/client.apis/PolicyApi
* @version 0.1
*/
export default class PolicyApi {
    ...
    * @alias module:client/client.apis/PolicyApi
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/PolicyApi~getAPIGroupCallback
     ...
     * @param {module:client/client.apis/PolicyApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

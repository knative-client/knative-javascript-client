...
* @module client/client.apis/Autoscaling_v2beta1Api
* @version 0.1
*/
export default class Autoscaling_v2beta1Api {
    ...
    * @alias module:client/client.apis/Autoscaling_v2beta1Api
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/Autoscaling_v2beta1Api~createNamespacedHorizontalPodAutoscalerCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V2beta1HorizontalPodAutoscaler} data The data returned by the service call.
     ...
     * @param {module:client/client.models/V2beta1HorizontalPodAutoscaler} body 
     ...
     * @param {module:client/client.apis/Autoscaling_v2beta1Api~createNamespacedHorizontalPodAutoscalerCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V2beta1HorizontalPodAutoscaler}
     */
     ...
     * @callback module:client/client.apis/Autoscaling_v2beta1Api~deleteCollectionNamespacedHorizontalPodAutoscalerCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:client/client.apis/Autoscaling_v2beta1Api~deleteCollectionNamespacedHorizontalPodAutoscalerCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:client/client.apis/Autoscaling_v2beta1Api~deleteNamespacedHorizontalPodAutoscalerCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1Status} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:client/client.apis/Autoscaling_v2beta1Api~deleteNamespacedHorizontalPodAutoscalerCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1Status}
     */
     ...
     * @callback module:client/client.apis/Autoscaling_v2beta1Api~getAPIResourcesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:client/client.apis/Autoscaling_v2beta1Api~getAPIResourcesCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:client/client.apis/Autoscaling_v2beta1Api~listHorizontalPodAutoscalerForAllNamespacesCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V2beta1HorizontalPodAutoscalerList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.timeoutSeconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
     * @param {Boolean} opts.watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:client/client.apis/Autoscaling_v2beta1Api~listHorizontalPodAutoscalerForAllNamespacesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V2beta1HorizontalPodAutoscalerList}
     */
     ...
     * @callback module:client/client.apis/Autoscaling_v2beta1Api~listNamespacedHorizontalPodAutoscalerCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V2beta1HorizontalPodAutoscalerList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.timeoutSeconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
     * @param {Boolean} opts.watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:client/client.apis/Autoscaling_v2beta1Api~listNamespacedHorizontalPodAutoscalerCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V2beta1HorizontalPodAutoscalerList}
     */
     ...
     * @callback module:client/client.apis/Autoscaling_v2beta1Api~patchNamespacedHorizontalPodAutoscalerCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V2beta1HorizontalPodAutoscaler} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:client/client.apis/Autoscaling_v2beta1Api~patchNamespacedHorizontalPodAutoscalerCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V2beta1HorizontalPodAutoscaler}
     */
     ...
     * @callback module:client/client.apis/Autoscaling_v2beta1Api~patchNamespacedHorizontalPodAutoscalerStatusCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V2beta1HorizontalPodAutoscaler} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. This field is required for apply requests (application/apply-patch) but optional for non-apply patch types (JsonPatch, MergePatch, StrategicMergePatch).
     * @param {Boolean} opts.force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
     * @param {module:client/client.apis/Autoscaling_v2beta1Api~patchNamespacedHorizontalPodAutoscalerStatusCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V2beta1HorizontalPodAutoscaler}
     */
     ...
     * @callback module:client/client.apis/Autoscaling_v2beta1Api~readNamespacedHorizontalPodAutoscalerCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V2beta1HorizontalPodAutoscaler} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:client/client.apis/Autoscaling_v2beta1Api~readNamespacedHorizontalPodAutoscalerCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V2beta1HorizontalPodAutoscaler}
     */
     ...
     * @callback module:client/client.apis/Autoscaling_v2beta1Api~readNamespacedHorizontalPodAutoscalerStatusCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V2beta1HorizontalPodAutoscaler} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.pretty If &#39;true&#39;, then the output is pretty printed.
     * @param {module:client/client.apis/Autoscaling_v2beta1Api~readNamespacedHorizontalPodAutoscalerStatusCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V2beta1HorizontalPodAutoscaler}
     */
     ...
     * @callback module:client/client.apis/Autoscaling_v2beta1Api~replaceNamespacedHorizontalPodAutoscalerCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V2beta1HorizontalPodAutoscaler} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
     * @param {String} opts.fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     * @param {module:client/client.apis/Autoscaling_v2beta1Api~replaceNamespacedHorizontalPodAutoscalerCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V2beta1HorizontalPodAutoscaler}
     */
     ...
     * @callback module:client/client.apis/Autoscaling_v2beta1Api~replaceNamespacedHorizontalPodAutoscalerStatusCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V2beta1HorizontalPodAutoscaler} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
     * @param {String} opts.fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     * @param {module:client/client.apis/Autoscaling_v2beta1Api~replaceNamespacedHorizontalPodAutoscalerStatusCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V2beta1HorizontalPodAutoscaler}
     */

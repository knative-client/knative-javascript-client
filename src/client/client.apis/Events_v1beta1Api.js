...
* @module client/client.apis/Events_v1beta1Api
* @version 0.1
*/
export default class Events_v1beta1Api {
    ...
    * @alias module:client/client.apis/Events_v1beta1Api
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/Events_v1beta1Api~createNamespacedEventCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1beta1Event} data The data returned by the service call.
     ...
     * @param {module:client/client.models/V1beta1Event} body 
     ...
     * @param {module:client/client.apis/Events_v1beta1Api~createNamespacedEventCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1beta1Event}
     */
     ...
     * @callback module:client/client.apis/Events_v1beta1Api~deleteCollectionNamespacedEventCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:client/client.apis/Events_v1beta1Api~deleteCollectionNamespacedEventCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:client/client.apis/Events_v1beta1Api~deleteNamespacedEventCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1Status} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:client/client.apis/Events_v1beta1Api~deleteNamespacedEventCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1Status}
     */
     ...
     * @callback module:client/client.apis/Events_v1beta1Api~getAPIResourcesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:client/client.apis/Events_v1beta1Api~getAPIResourcesCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:client/client.apis/Events_v1beta1Api~listEventForAllNamespacesCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1beta1EventList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.timeoutSeconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
     * @param {Boolean} opts.watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:client/client.apis/Events_v1beta1Api~listEventForAllNamespacesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1beta1EventList}
     */
     ...
     * @callback module:client/client.apis/Events_v1beta1Api~listNamespacedEventCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1beta1EventList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.timeoutSeconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
     * @param {Boolean} opts.watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:client/client.apis/Events_v1beta1Api~listNamespacedEventCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1beta1EventList}
     */
     ...
     * @callback module:client/client.apis/Events_v1beta1Api~patchNamespacedEventCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1beta1Event} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:client/client.apis/Events_v1beta1Api~patchNamespacedEventCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1beta1Event}
     */
     ...
     * @callback module:client/client.apis/Events_v1beta1Api~readNamespacedEventCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1beta1Event} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:client/client.apis/Events_v1beta1Api~readNamespacedEventCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1beta1Event}
     */
     ...
     * @callback module:client/client.apis/Events_v1beta1Api~replaceNamespacedEventCallback
     * @param {String} error Error message, if any.
     * @param {module:client/client.models/V1beta1Event} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
     * @param {String} opts.fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     * @param {module:client/client.apis/Events_v1beta1Api~replaceNamespacedEventCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client/client.models/V1beta1Event}
     */

...
/**
* Autoscaling service.
* @module client/client.apis/AutoscalingApi
* @version 0.1
*/
export default class AutoscalingApi {

    /**
    * Constructs a new AutoscalingApi. 
    * @alias module:client/client.apis/AutoscalingApi
    * @class
    ...
    */
     ...
     * @callback module:client/client.apis/AutoscalingApi~getAPIGroupCallback
     ...
     * @param {module:client/client.apis/AutoscalingApi~getAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response

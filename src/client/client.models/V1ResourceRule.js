...
/**
* The V1ResourceRule model module.
* @module client/client.models/V1ResourceRule
* @version 0.1
*/
export default class V1ResourceRule {
    /**
    * Constructs a new <code>V1ResourceRule</code>.
    * ResourceRule is the list of actions the subject is allowed to perform on resources. The list ordering isn&#39;t significant, may contain duplicates, and possibly be incomplete.
    * @alias module:client/client.models/V1ResourceRule
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>V1ResourceRule</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:client/client.models/V1ResourceRule} obj Optional instance to populate.
    * @return {module:client/client.models/V1ResourceRule} The populated <code>V1ResourceRule</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1ResourceRule();

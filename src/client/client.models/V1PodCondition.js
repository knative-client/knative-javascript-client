...
* @module client/client.models/V1PodCondition
* @version 0.1
*/
export default class V1PodCondition {
    ...
    * @alias module:client/client.models/V1PodCondition
    * @class
    ...
    * @param {module:client/client.models/V1PodCondition} obj Optional instance to populate.
    * @return {module:client/client.models/V1PodCondition} The populated <code>V1PodCondition</code> instance.
    */

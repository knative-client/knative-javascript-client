...
* @module client/client.models/V1HostPathVolumeSource
* @version 0.1
*/
export default class V1HostPathVolumeSource {
    ...
    * @alias module:client/client.models/V1HostPathVolumeSource
    * @class
    ...
    * @param {module:client/client.models/V1HostPathVolumeSource} obj Optional instance to populate.
    * @return {module:client/client.models/V1HostPathVolumeSource} The populated <code>V1HostPathVolumeSource</code> instance.
    */

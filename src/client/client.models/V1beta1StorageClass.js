...
* @module client/client.models/V1beta1StorageClass
* @version 0.1
*/
export default class V1beta1StorageClass {
    ...
    * @alias module:client/client.models/V1beta1StorageClass
    * @class
    ...
    * @param {module:client/client.models/V1beta1StorageClass} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta1StorageClass} The populated <code>V1beta1StorageClass</code> instance.
    */

...
* @module client/client.models/V1APIResource
* @version 0.1
*/
export default class V1APIResource {
    ...
    * @alias module:client/client.models/V1APIResource
    * @class
    ...
    * @param {module:client/client.models/V1APIResource} obj Optional instance to populate.
    * @return {module:client/client.models/V1APIResource} The populated <code>V1APIResource</code> instance.
    */

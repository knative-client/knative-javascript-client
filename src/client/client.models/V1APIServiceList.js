...
* @module client/client.models/V1APIServiceList
* @version 0.1
*/
export default class V1APIServiceList {
    ...
    * @alias module:client/client.models/V1APIServiceList
    * @class
    * @param items {Array.<module:client/client.models/V1APIService>} 
    */
    ...
    * @param {module:client/client.models/V1APIServiceList} obj Optional instance to populate.
    * @return {module:client/client.models/V1APIServiceList} The populated <code>V1APIServiceList</code> instance.
    */
    ...
    */
    ...
    /**
    * @member {Array.<module:client/client.models/V1APIService>} items
    */
    items = undefined;
    /**

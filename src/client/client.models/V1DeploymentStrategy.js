...
* @module client/client.models/V1DeploymentStrategy
* @version 0.1
*/
export default class V1DeploymentStrategy {
    ...
    * @alias module:client/client.models/V1DeploymentStrategy
    * @class
    */
    ...
    * @param {module:client/client.models/V1DeploymentStrategy} obj Optional instance to populate.
    * @return {module:client/client.models/V1DeploymentStrategy} The populated <code>V1DeploymentStrategy</code> instance.
    */
    ...
    * @member {module:client/client.models/V1RollingUpdateDeployment} rollingUpdate
    */

...
* @module client/client.models/V1ResourceQuota
* @version 0.1
*/
export default class V1ResourceQuota {
    ...
    * @alias module:client/client.models/V1ResourceQuota
    * @class
    */
    ...
    * @param {module:client/client.models/V1ResourceQuota} obj Optional instance to populate.
    * @return {module:client/client.models/V1ResourceQuota} The populated <code>V1ResourceQuota</code> instance.
    */
    ...
    * @member {module:client/client.models/V1ResourceQuotaSpec} spec
    */
    spec = undefined;
    /**
    * Status defines the actual enforced quota and its current usage. https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
    * @member {module:client/client.models/V1ResourceQuotaStatus} status
    */
    status = undefined;

...
* @module client/client.models/V1beta2ReplicaSetSpec
* @version 0.1
*/
export default class V1beta2ReplicaSetSpec {
    ...
    * @alias module:client/client.models/V1beta2ReplicaSetSpec
    * @class
    ...
    * @param {module:client/client.models/V1beta2ReplicaSetSpec} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta2ReplicaSetSpec} The populated <code>V1beta2ReplicaSetSpec</code> instance.
    */

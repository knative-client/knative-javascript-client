...
* @module client/client.models/V1beta1PolicyRule
* @version 0.1
*/
export default class V1beta1PolicyRule {
    /**
    * Constructs a new <code>V1beta1PolicyRule</code>.
    * PolicyRule holds information that describes a policy rule, but does not contain information about who the rule applies to or which namespace the rule applies to.
    * @alias module:client/client.models/V1beta1PolicyRule
    * @class
    ...
    * @param {module:client/client.models/V1beta1PolicyRule} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta1PolicyRule} The populated <code>V1beta1PolicyRule</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1beta1PolicyRule();

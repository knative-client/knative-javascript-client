...
* @module client/client.models/V1Node
* @version 0.1
*/
export default class V1Node {
    ...
    * @alias module:client/client.models/V1Node
    * @class
    */
    ...
    * @param {module:client/client.models/V1Node} obj Optional instance to populate.
    * @return {module:client/client.models/V1Node} The populated <code>V1Node</code> instance.
    */
    ...
    * @member {module:client/client.models/V1NodeSpec} spec
    */
    spec = undefined;
    /**
    * Most recently observed status of the node. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
    * @member {module:client/client.models/V1NodeStatus} status
    */
    status = undefined;

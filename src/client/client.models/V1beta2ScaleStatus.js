...
* @module client/client.models/V1beta2ScaleStatus
* @version 0.1
*/
export default class V1beta2ScaleStatus {
    ...
    * @alias module:client/client.models/V1beta2ScaleStatus
    * @class
    ...
    * @param {module:client/client.models/V1beta2ScaleStatus} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta2ScaleStatus} The populated <code>V1beta2ScaleStatus</code> instance.
    */

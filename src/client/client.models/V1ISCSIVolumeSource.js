...
* @module client/client.models/V1ISCSIVolumeSource
* @version 0.1
*/
export default class V1ISCSIVolumeSource {
    /**
    * Constructs a new <code>V1ISCSIVolumeSource</code>.
    * Represents an ISCSI disk. ISCSI volumes can only be mounted as read/write once. ISCSI volumes support ownership management and SELinux relabeling.
    * @alias module:client/client.models/V1ISCSIVolumeSource
    * @class
    ...
    * @param {module:client/client.models/V1ISCSIVolumeSource} obj Optional instance to populate.
    * @return {module:client/client.models/V1ISCSIVolumeSource} The populated <code>V1ISCSIVolumeSource</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1ISCSIVolumeSource();

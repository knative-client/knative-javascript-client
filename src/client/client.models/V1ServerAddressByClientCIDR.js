...
* @module client/client.models/V1ServerAddressByClientCIDR
* @version 0.1
*/
export default class V1ServerAddressByClientCIDR {
    ...
    * @alias module:client/client.models/V1ServerAddressByClientCIDR
    * @class
    ...
    * @param {module:client/client.models/V1ServerAddressByClientCIDR} obj Optional instance to populate.
    * @return {module:client/client.models/V1ServerAddressByClientCIDR} The populated <code>V1ServerAddressByClientCIDR</code> instance.
    */

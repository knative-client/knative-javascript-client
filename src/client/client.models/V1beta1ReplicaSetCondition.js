...
* @module client/client.models/V1beta1ReplicaSetCondition
* @version 0.1
*/
export default class V1beta1ReplicaSetCondition {
    /**
    * Constructs a new <code>V1beta1ReplicaSetCondition</code>.
    * ReplicaSetCondition describes the state of a replica set at a certain point.
    * @alias module:client/client.models/V1beta1ReplicaSetCondition
    * @class
    ...
    * @param {module:client/client.models/V1beta1ReplicaSetCondition} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta1ReplicaSetCondition} The populated <code>V1beta1ReplicaSetCondition</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1beta1ReplicaSetCondition();

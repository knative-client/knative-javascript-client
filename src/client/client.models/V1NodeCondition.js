...
* @module client/client.models/V1NodeCondition
* @version 0.1
*/
export default class V1NodeCondition {
    ...
    * @alias module:client/client.models/V1NodeCondition
    * @class
    ...
    * @param {module:client/client.models/V1NodeCondition} obj Optional instance to populate.
    * @return {module:client/client.models/V1NodeCondition} The populated <code>V1NodeCondition</code> instance.
    */

...
* @module client/client.models/V1Event
* @version 0.1
*/
export default class V1Event {
    ...
    * @alias module:client/client.models/V1Event
    * @class
    * @param involvedObject {module:client/client.models/V1ObjectReference} The object that this event is about.
    * @param metadata {module:client/client.models/V1ObjectMeta} Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata
    */
    ...
    * @param {module:client/client.models/V1Event} obj Optional instance to populate.
    * @return {module:client/client.models/V1Event} The populated <code>V1Event</code> instance.
    */
    ...
    * @member {module:client/client.models/V1ObjectReference} involvedObject
    */
    ...
    * @member {module:client/client.models/V1ObjectReference} related
    */
    related = undefined;
    /**
    ...
    * @member {module:client/client.models/V1EventSeries} series
    */
    series = undefined;
    /**
    * The component reporting this event. Should be a short machine understandable string.
    * @member {module:client/client.models/V1EventSource} source
    */
    source = undefined;
    /**

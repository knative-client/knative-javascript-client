...
* @module client/client.models/V1NonResourceAttributes
* @version 0.1
*/
export default class V1NonResourceAttributes {
    ...
    * @alias module:client/client.models/V1NonResourceAttributes
    * @class
    */
    ...
    * @param {module:client/client.models/V1NonResourceAttributes} obj Optional instance to populate.
    * @return {module:client/client.models/V1NonResourceAttributes} The populated <code>V1NonResourceAttributes</code> instance.
    */

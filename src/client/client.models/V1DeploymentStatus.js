...
* @module client/client.models/V1DeploymentStatus
* @version 0.1
*/
export default class V1DeploymentStatus {
    ...
    * @alias module:client/client.models/V1DeploymentStatus
    * @class
    */
    ...
    * @param {module:client/client.models/V1DeploymentStatus} obj Optional instance to populate.
    * @return {module:client/client.models/V1DeploymentStatus} The populated <code>V1DeploymentStatus</code> instance.
    */
    ...
    * @member {Array.<module:client/client.models/V1DeploymentCondition>} conditions
    */

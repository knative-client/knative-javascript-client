...
* @module client/client.models/V1EnvVarSource
* @version 0.1
*/
export default class V1EnvVarSource {
    ...
    * @alias module:client/client.models/V1EnvVarSource
    * @class
    */
    ...
    * @param {module:client/client.models/V1EnvVarSource} obj Optional instance to populate.
    * @return {module:client/client.models/V1EnvVarSource} The populated <code>V1EnvVarSource</code> instance.
    */
    ...
    * @member {module:client/client.models/V1ConfigMapKeySelector} configMapKeyRef
    */
    ...
    * @member {module:client/client.models/V1SecretKeySelector} secretKeyRef
    */

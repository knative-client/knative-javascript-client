...
* @module client/client.models/V1NodeSpec
* @version 0.1
*/
export default class V1NodeSpec {
    ...
    * @alias module:client/client.models/V1NodeSpec
    * @class
    */
    ...
    * @param {module:client/client.models/V1NodeSpec} obj Optional instance to populate.
    * @return {module:client/client.models/V1NodeSpec} The populated <code>V1NodeSpec</code> instance.
    */
    ...
    * @member {module:client/client.models/V1NodeConfigSource} configSource
    */
    ...
    * @member {Array.<module:client/client.models/V1Taint>} taints
    */
    taints = undefined;
    /**

...
* @module client/client.models/V1CinderVolumeSource
* @version 0.1
*/
export default class V1CinderVolumeSource {
    ...
    * @alias module:client/client.models/V1CinderVolumeSource
    * @class
    ...
    * @param {module:client/client.models/V1CinderVolumeSource} obj Optional instance to populate.
    * @return {module:client/client.models/V1CinderVolumeSource} The populated <code>V1CinderVolumeSource</code> instance.
    */

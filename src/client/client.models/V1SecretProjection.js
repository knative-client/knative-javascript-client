...
* @module client/client.models/V1SecretProjection
* @version 0.1
*/
export default class V1SecretProjection {
    ...
    * @alias module:client/client.models/V1SecretProjection
    * @class
    */
    ...
    * @param {module:client/client.models/V1SecretProjection} obj Optional instance to populate.
    * @return {module:client/client.models/V1SecretProjection} The populated <code>V1SecretProjection</code> instance.
    */

...
* @module client/client.models/RuntimeRawExtension
* @version 0.1
*/
export default class RuntimeRawExtension {
    ...
    * @alias module:client/client.models/RuntimeRawExtension
    * @class
    ...
    * @param {module:client/client.models/RuntimeRawExtension} obj Optional instance to populate.
    * @return {module:client/client.models/RuntimeRawExtension} The populated <code>RuntimeRawExtension</code> instance.
    */

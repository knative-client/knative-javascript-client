...
* @module client/client.models/V1AzureFileVolumeSource
* @version 0.1
*/
export default class V1AzureFileVolumeSource {
    ...
    * @alias module:client/client.models/V1AzureFileVolumeSource
    * @class
    ...
    * @param {module:client/client.models/V1AzureFileVolumeSource} obj Optional instance to populate.
    * @return {module:client/client.models/V1AzureFileVolumeSource} The populated <code>V1AzureFileVolumeSource</code> instance.
    */

...
* @module client/client.models/V1beta1Role
* @version 0.1
*/
export default class V1beta1Role {
    ...
    * @alias module:client/client.models/V1beta1Role
    * @class
    */
    ...
    * @param {module:client/client.models/V1beta1Role} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta1Role} The populated <code>V1beta1Role</code> instance.
    */

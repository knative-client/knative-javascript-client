...
/**
* The V1RBDPersistentVolumeSource model module.
* @module client/client.models/V1RBDPersistentVolumeSource
* @version 0.1
*/
export default class V1RBDPersistentVolumeSource {
    /**
    * Constructs a new <code>V1RBDPersistentVolumeSource</code>.
    * Represents a Rados Block Device mount that lasts the lifetime of a pod. RBD volumes support ownership management and SELinux relabeling.
    * @alias module:client/client.models/V1RBDPersistentVolumeSource
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>V1RBDPersistentVolumeSource</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:client/client.models/V1RBDPersistentVolumeSource} obj Optional instance to populate.
    * @return {module:client/client.models/V1RBDPersistentVolumeSource} The populated <code>V1RBDPersistentVolumeSource</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1RBDPersistentVolumeSource();

...
* @module client/client.models/V1LimitRangeItem
* @version 0.1
*/
export default class V1LimitRangeItem {
    ...
    * @alias module:client/client.models/V1LimitRangeItem
    * @class
    */
    ...
    * @param {module:client/client.models/V1LimitRangeItem} obj Optional instance to populate.
    * @return {module:client/client.models/V1LimitRangeItem} The populated <code>V1LimitRangeItem</code> instance.
    */

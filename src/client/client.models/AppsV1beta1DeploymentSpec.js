...
* @module client/client.models/AppsV1beta1DeploymentSpec
* @version 0.1
*/
export default class AppsV1beta1DeploymentSpec {
    ...
    * @alias module:client/client.models/AppsV1beta1DeploymentSpec
    * @class
    ...
    * @param {module:client/client.models/AppsV1beta1DeploymentSpec} obj Optional instance to populate.
    * @return {module:client/client.models/AppsV1beta1DeploymentSpec} The populated <code>AppsV1beta1DeploymentSpec</code> instance.
    */
    ...
    * @member {module:client/client.models/AppsV1beta1DeploymentStrategy} strategy
    */
    strategy = undefined;
    /**

...
* @module client/client.models/V1Taint
* @version 0.1
*/
export default class V1Taint {
    ...
    * @alias module:client/client.models/V1Taint
    * @class
    ...
    * @param {module:client/client.models/V1Taint} obj Optional instance to populate.
    * @return {module:client/client.models/V1Taint} The populated <code>V1Taint</code> instance.
    */

...
* @module client/client.models/V1StatefulSetStatus
* @version 0.1
*/
export default class V1StatefulSetStatus {
    ...
    * @alias module:client/client.models/V1StatefulSetStatus
    * @class
    ...
    * @param {module:client/client.models/V1StatefulSetStatus} obj Optional instance to populate.
    * @return {module:client/client.models/V1StatefulSetStatus} The populated <code>V1StatefulSetStatus</code> instance.
    */
    ...
    * @member {Array.<module:client/client.models/V1StatefulSetCondition>} conditions
    */

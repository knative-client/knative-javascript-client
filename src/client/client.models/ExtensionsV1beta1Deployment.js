...
* @module client/client.models/ExtensionsV1beta1Deployment
* @version 0.1
*/
export default class ExtensionsV1beta1Deployment {
    ...
    * @alias module:client/client.models/ExtensionsV1beta1Deployment
    * @class
    */
    ...
    * @param {module:client/client.models/ExtensionsV1beta1Deployment} obj Optional instance to populate.
    * @return {module:client/client.models/ExtensionsV1beta1Deployment} The populated <code>ExtensionsV1beta1Deployment</code> instance.
    */
    ...
    * @member {module:client/client.models/ExtensionsV1beta1DeploymentSpec} spec
    */
    spec = undefined;
    /**
    * Most recently observed status of the Deployment.
    * @member {module:client/client.models/ExtensionsV1beta1DeploymentStatus} status
    */
    status = undefined;

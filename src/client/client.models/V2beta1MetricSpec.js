...
* @module client/client.models/V2beta1MetricSpec
* @version 0.1
*/
export default class V2beta1MetricSpec {
    ...
    * @alias module:client/client.models/V2beta1MetricSpec
    * @class
    ...
    * @param {module:client/client.models/V2beta1MetricSpec} obj Optional instance to populate.
    * @return {module:client/client.models/V2beta1MetricSpec} The populated <code>V2beta1MetricSpec</code> instance.
    */
    ...
    * @member {module:client/client.models/V2beta1ExternalMetricSource} external
    */
    external = undefined;
    /**
    * object refers to a metric describing a single kubernetes object (for example, hits-per-second on an Ingress object).
    * @member {module:client/client.models/V2beta1ObjectMetricSource} object
    */
    object = undefined;
    /**
    * pods refers to a metric describing each pod in the current scale target (for example, transactions-processed-per-second).  The values will be averaged together before being compared to the target value.
    * @member {module:client/client.models/V2beta1PodsMetricSource} pods
    */
    pods = undefined;
    /**
    * resource refers to a resource metric (such as those specified in requests and limits) known to Kubernetes describing each pod in the current scale target (e.g. CPU or memory). Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the \"pods\" source.
    * @member {module:client/client.models/V2beta1ResourceMetricSource} resource
    */
    resource = undefined;
    /**

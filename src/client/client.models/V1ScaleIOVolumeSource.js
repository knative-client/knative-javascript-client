...
* @module client/client.models/V1ScaleIOVolumeSource
* @version 0.1
*/
export default class V1ScaleIOVolumeSource {
    /**
    * Constructs a new <code>V1ScaleIOVolumeSource</code>.
    * ScaleIOVolumeSource represents a persistent ScaleIO volume
    * @alias module:client/client.models/V1ScaleIOVolumeSource
    * @class
    * @param gateway {String} The host address of the ScaleIO API Gateway.
    * @param secretRef {module:client/client.models/V1LocalObjectReference} SecretRef references to the secret for ScaleIO user and other sensitive information. If this is not provided, Login operation will fail.
    ...
    * @param {module:client/client.models/V1ScaleIOVolumeSource} obj Optional instance to populate.
    * @return {module:client/client.models/V1ScaleIOVolumeSource} The populated <code>V1ScaleIOVolumeSource</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1ScaleIOVolumeSource();
    ...
    * @member {module:client/client.models/V1LocalObjectReference} secretRef
    */
    secretRef = undefined;
    /**

...
* @module client/client.models/V1beta2DaemonSetStatus
* @version 0.1
*/
export default class V1beta2DaemonSetStatus {
    ...
    * @alias module:client/client.models/V1beta2DaemonSetStatus
    * @class
    ...
    * @param {module:client/client.models/V1beta2DaemonSetStatus} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta2DaemonSetStatus} The populated <code>V1beta2DaemonSetStatus</code> instance.
    */
    ...
    * @member {Array.<module:client/client.models/V1beta2DaemonSetCondition>} conditions
    */

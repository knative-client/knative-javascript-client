...
* @module client/client.models/V1beta1ValidatingWebhookConfiguration
* @version 0.1
*/
export default class V1beta1ValidatingWebhookConfiguration {
    ...
    * @alias module:client/client.models/V1beta1ValidatingWebhookConfiguration
    * @class
    */
    ...
    * @param {module:client/client.models/V1beta1ValidatingWebhookConfiguration} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta1ValidatingWebhookConfiguration} The populated <code>V1beta1ValidatingWebhookConfiguration</code> instance.
    */

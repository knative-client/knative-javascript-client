...
* @module client/client.models/V1ClusterRoleBindingList
* @version 0.1
*/
export default class V1ClusterRoleBindingList {
    ...
    * @alias module:client/client.models/V1ClusterRoleBindingList
    * @class
    * @param items {Array.<module:client/client.models/V1ClusterRoleBinding>} Items is a list of ClusterRoleBindings
    */
    ...
    * @param {module:client/client.models/V1ClusterRoleBindingList} obj Optional instance to populate.
    * @return {module:client/client.models/V1ClusterRoleBindingList} The populated <code>V1ClusterRoleBindingList</code> instance.
    */
    ...
    * @member {Array.<module:client/client.models/V1ClusterRoleBinding>} items
    */
    items = undefined;
    /**

...
* @module client/client.models/V1beta1DaemonSetSpec
* @version 0.1
*/
export default class V1beta1DaemonSetSpec {
    ...
    * @alias module:client/client.models/V1beta1DaemonSetSpec
    * @class
    ...
    * @param {module:client/client.models/V1beta1DaemonSetSpec} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta1DaemonSetSpec} The populated <code>V1beta1DaemonSetSpec</code> instance.
    */
    ...
    * @member {module:client/client.models/V1beta1DaemonSetUpdateStrategy} updateStrategy
    */

...
/**
* The V1beta1CronJobSpec model module.
* @module client/client.models/V1beta1CronJobSpec
* @version 0.1
*/
export default class V1beta1CronJobSpec {
    /**
    * Constructs a new <code>V1beta1CronJobSpec</code>.
    * CronJobSpec describes how the job execution will look like and when it will actually run.
    * @alias module:client/client.models/V1beta1CronJobSpec
    * @class
    * @param jobTemplate {module:client/client.models/V1beta1JobTemplateSpec} Specifies the job that will be created when executing a CronJob.
    ...
    */
    ...
    /**
    * Constructs a <code>V1beta1CronJobSpec</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:client/client.models/V1beta1CronJobSpec} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta1CronJobSpec} The populated <code>V1beta1CronJobSpec</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1beta1CronJobSpec();
            ...
            if (data.hasOwnProperty('jobTemplate')) {
                obj['jobTemplate'] = V1beta1JobTemplateSpec.constructFromObject(data['jobTemplate']);
            }
    ...
    * @member {module:client/client.models/V1beta1JobTemplateSpec} jobTemplate
    */

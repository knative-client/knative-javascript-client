...
/**
* The V1beta2DeploymentStatus model module.
* @module client/client.models/V1beta2DeploymentStatus
* @version 0.1
*/
export default class V1beta2DeploymentStatus {
    /**
    * Constructs a new <code>V1beta2DeploymentStatus</code>.
    * DeploymentStatus is the most recently observed status of the Deployment.
    * @alias module:client/client.models/V1beta2DeploymentStatus
    * @class
    */
    ...
    /**
    * Constructs a <code>V1beta2DeploymentStatus</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:client/client.models/V1beta2DeploymentStatus} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta2DeploymentStatus} The populated <code>V1beta2DeploymentStatus</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1beta2DeploymentStatus();
            ...
            if (data.hasOwnProperty('conditions')) {
                obj['conditions'] = ApiClient.convertToType(data['conditions'], [V1beta2DeploymentCondition]);
            }
    ...
    * @member {Array.<module:client/client.models/V1beta2DeploymentCondition>} conditions
    */

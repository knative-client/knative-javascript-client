...
* @module client/client.models/V1RollingUpdateDeployment
* @version 0.1
*/
export default class V1RollingUpdateDeployment {
    ...
    * @alias module:client/client.models/V1RollingUpdateDeployment
    * @class
    */
    ...
    * @param {module:client/client.models/V1RollingUpdateDeployment} obj Optional instance to populate.
    * @return {module:client/client.models/V1RollingUpdateDeployment} The populated <code>V1RollingUpdateDeployment</code> instance.
    */

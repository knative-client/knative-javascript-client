...
* @module client/client.models/V1StorageOSVolumeSource
* @version 0.1
*/
export default class V1StorageOSVolumeSource {
    ...
    * @alias module:client/client.models/V1StorageOSVolumeSource
    * @class
    */
    ...
    * @param {module:client/client.models/V1StorageOSVolumeSource} obj Optional instance to populate.
    * @return {module:client/client.models/V1StorageOSVolumeSource} The populated <code>V1StorageOSVolumeSource</code> instance.
    */

...
* @module client/client.models/V1StatusDetails
* @version 0.1
*/
export default class V1StatusDetails {
    ...
    * @alias module:client/client.models/V1StatusDetails
    * @class
    */
    ...
    * @param {module:client/client.models/V1StatusDetails} obj Optional instance to populate.
    * @return {module:client/client.models/V1StatusDetails} The populated <code>V1StatusDetails</code> instance.
    */
    ...
    * @member {Array.<module:client/client.models/V1StatusCause>} causes
    */
    causes = undefined;
    /**

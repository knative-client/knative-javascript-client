...
* @module client/client.models/V1OwnerReference
* @version 0.1
*/
export default class V1OwnerReference {
    ...
    * @alias module:client/client.models/V1OwnerReference
    * @class
    ...
    * @param {module:client/client.models/V1OwnerReference} obj Optional instance to populate.
    * @return {module:client/client.models/V1OwnerReference} The populated <code>V1OwnerReference</code> instance.
    */

...
* @module client/client.models/V1CephFSVolumeSource
* @version 0.1
*/
export default class V1CephFSVolumeSource {
    ...
    * @alias module:client/client.models/V1CephFSVolumeSource
    * @class
    ...
    * @param {module:client/client.models/V1CephFSVolumeSource} obj Optional instance to populate.
    * @return {module:client/client.models/V1CephFSVolumeSource} The populated <code>V1CephFSVolumeSource</code> instance.
    */

...
* @module client/client.models/ExtensionsV1beta1DeploymentStatus
* @version 0.1
*/
export default class ExtensionsV1beta1DeploymentStatus {
    /**
    * Constructs a new <code>ExtensionsV1beta1DeploymentStatus</code>.
    * DeploymentStatus is the most recently observed status of the Deployment.
    * @alias module:client/client.models/ExtensionsV1beta1DeploymentStatus
    * @class
    */
    ...
    * @param {module:client/client.models/ExtensionsV1beta1DeploymentStatus} obj Optional instance to populate.
    * @return {module:client/client.models/ExtensionsV1beta1DeploymentStatus} The populated <code>ExtensionsV1beta1DeploymentStatus</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExtensionsV1beta1DeploymentStatus();
    ...
    * @member {Array.<module:client/client.models/ExtensionsV1beta1DeploymentCondition>} conditions
    */

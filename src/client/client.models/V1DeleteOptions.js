...
* @module client/client.models/V1DeleteOptions
* @version 0.1
*/
export default class V1DeleteOptions {
    ...
    * @alias module:client/client.models/V1DeleteOptions
    * @class
    */
    ...
    * @param {module:client/client.models/V1DeleteOptions} obj Optional instance to populate.
    * @return {module:client/client.models/V1DeleteOptions} The populated <code>V1DeleteOptions</code> instance.
    */

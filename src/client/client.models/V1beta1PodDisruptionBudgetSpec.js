...
* @module client/client.models/V1beta1PodDisruptionBudgetSpec
* @version 0.1
*/
export default class V1beta1PodDisruptionBudgetSpec {
    ...
    * @alias module:client/client.models/V1beta1PodDisruptionBudgetSpec
    * @class
    */
    ...
    * @param {module:client/client.models/V1beta1PodDisruptionBudgetSpec} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta1PodDisruptionBudgetSpec} The populated <code>V1beta1PodDisruptionBudgetSpec</code> instance.
    */

...
* @module client/client.models/V1AzureDiskVolumeSource
* @version 0.1
*/
export default class V1AzureDiskVolumeSource {
    ...
    * @alias module:client/client.models/V1AzureDiskVolumeSource
    * @class
    ...
    * @param {module:client/client.models/V1AzureDiskVolumeSource} obj Optional instance to populate.
    * @return {module:client/client.models/V1AzureDiskVolumeSource} The populated <code>V1AzureDiskVolumeSource</code> instance.
    */

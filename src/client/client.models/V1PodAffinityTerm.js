...
* @module client/client.models/V1PodAffinityTerm
* @version 0.1
*/
export default class V1PodAffinityTerm {
    ...
    * @alias module:client/client.models/V1PodAffinityTerm
    * @class
    ...
    * @param {module:client/client.models/V1PodAffinityTerm} obj Optional instance to populate.
    * @return {module:client/client.models/V1PodAffinityTerm} The populated <code>V1PodAffinityTerm</code> instance.
    */
    ...
    * @member {module:client/client.models/V1LabelSelector} labelSelector
    */

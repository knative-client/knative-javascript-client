...
* @module client/client.models/V1FlexVolumeSource
* @version 0.1
*/
export default class V1FlexVolumeSource {
    ...
    * @alias module:client/client.models/V1FlexVolumeSource
    * @class
    ...
    * @param {module:client/client.models/V1FlexVolumeSource} obj Optional instance to populate.
    * @return {module:client/client.models/V1FlexVolumeSource} The populated <code>V1FlexVolumeSource</code> instance.
    */

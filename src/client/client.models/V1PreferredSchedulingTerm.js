...
* @module client/client.models/V1PreferredSchedulingTerm
* @version 0.1
*/
export default class V1PreferredSchedulingTerm {
    ...
    * @alias module:client/client.models/V1PreferredSchedulingTerm
    * @class
    * @param preference {module:client/client.models/V1NodeSelectorTerm} A node selector term, associated with the corresponding weight.
    ...
    * @param {module:client/client.models/V1PreferredSchedulingTerm} obj Optional instance to populate.
    * @return {module:client/client.models/V1PreferredSchedulingTerm} The populated <code>V1PreferredSchedulingTerm</code> instance.
    */
    ...
    * @member {module:client/client.models/V1NodeSelectorTerm} preference
    */

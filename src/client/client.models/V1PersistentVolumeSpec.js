...
* @module client/client.models/V1PersistentVolumeSpec
* @version 0.1
*/
export default class V1PersistentVolumeSpec {
    ...
    * @alias module:client/client.models/V1PersistentVolumeSpec
    * @class
    */
    ...
    * @param {module:client/client.models/V1PersistentVolumeSpec} obj Optional instance to populate.
    * @return {module:client/client.models/V1PersistentVolumeSpec} The populated <code>V1PersistentVolumeSpec</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('cinder')) {
                obj['cinder'] = V1CinderPersistentVolumeSource.constructFromObject(data['cinder']);
            }
            ...
            if (data.hasOwnProperty('glusterfs')) {
                obj['glusterfs'] = V1GlusterfsPersistentVolumeSource.constructFromObject(data['glusterfs']);
            }
    ...
    * @member {module:client/client.models/V1AzureFilePersistentVolumeSource} azureFile
    */
    azureFile = undefined;
    /**
    ...
    * @member {module:client/client.models/V1CephFSPersistentVolumeSource} cephfs
    */
    cephfs = undefined;
    /**
    * Cinder represents a cinder volume attached and mounted on kubelets host machine More info: https://releases.k8s.io/HEAD/examples/mysql-cinder-pd/README.md
    * @member {module:client/client.models/V1CinderPersistentVolumeSource} cinder
    */
    cinder = undefined;
    /**
    * ClaimRef is part of a bi-directional binding between PersistentVolume and PersistentVolumeClaim. Expected to be non-nil when bound. claim.VolumeName is the authoritative bind between PV and PVC. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#binding
    * @member {module:client/client.models/V1ObjectReference} claimRef
    */
    claimRef = undefined;
    /**
    * CSI represents storage that is handled by an external CSI driver (Beta feature).
    * @member {module:client/client.models/V1CSIPersistentVolumeSource} csi
    */
    csi = undefined;
    /**
    ...
    * @member {module:client/client.models/V1FlexPersistentVolumeSource} flexVolume
    */
    ...
    * @member {module:client/client.models/V1GlusterfsPersistentVolumeSource} glusterfs
    */
    glusterfs = undefined;
    /**
    ...
    * @member {module:client/client.models/V1ISCSIPersistentVolumeSource} iscsi
    */
    iscsi = undefined;
    /**
    * Local represents directly-attached storage with node affinity
    * @member {module:client/client.models/V1LocalVolumeSource} local
    */
    local = undefined;
    /**
    ...
    * @member {module:client/client.models/V1VolumeNodeAffinity} nodeAffinity
    */
    ...
    * @member {module:client/client.models/V1RBDPersistentVolumeSource} rbd
    */
    rbd = undefined;
    /**
    * ScaleIO represents a ScaleIO persistent volume attached and mounted on Kubernetes nodes.
    * @member {module:client/client.models/V1ScaleIOPersistentVolumeSource} scaleIO
    */
    scaleIO = undefined;
    /**
    ...
    * @member {module:client/client.models/V1StorageOSPersistentVolumeSource} storageos
    */
    storageos = undefined;
    /**

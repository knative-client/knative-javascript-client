...
* @module client/client.models/V1Handler
* @version 0.1
*/
export default class V1Handler {
    ...
    * @alias module:client/client.models/V1Handler
    * @class
    */
    ...
    * @param {module:client/client.models/V1Handler} obj Optional instance to populate.
    * @return {module:client/client.models/V1Handler} The populated <code>V1Handler</code> instance.
    */

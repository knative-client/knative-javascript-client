...
* @module client/client.models/V1RBDVolumeSource
* @version 0.1
*/
export default class V1RBDVolumeSource {
    ...
    * @alias module:client/client.models/V1RBDVolumeSource
    * @class
    ...
    * @param {module:client/client.models/V1RBDVolumeSource} obj Optional instance to populate.
    * @return {module:client/client.models/V1RBDVolumeSource} The populated <code>V1RBDVolumeSource</code> instance.
    */

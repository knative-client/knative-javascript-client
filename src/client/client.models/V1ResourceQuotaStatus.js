...
* @module client/client.models/V1ResourceQuotaStatus
* @version 0.1
*/
export default class V1ResourceQuotaStatus {
    ...
    * @alias module:client/client.models/V1ResourceQuotaStatus
    * @class
    */
    ...
    * @param {module:client/client.models/V1ResourceQuotaStatus} obj Optional instance to populate.
    * @return {module:client/client.models/V1ResourceQuotaStatus} The populated <code>V1ResourceQuotaStatus</code> instance.
    */

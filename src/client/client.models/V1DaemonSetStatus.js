...
/**
* The V1DaemonSetStatus model module.
* @module client/client.models/V1DaemonSetStatus
* @version 0.1
*/
export default class V1DaemonSetStatus {
    /**
    * Constructs a new <code>V1DaemonSetStatus</code>.
    * DaemonSetStatus represents the current status of a daemon set.
    * @alias module:client/client.models/V1DaemonSetStatus
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>V1DaemonSetStatus</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:client/client.models/V1DaemonSetStatus} obj Optional instance to populate.
    * @return {module:client/client.models/V1DaemonSetStatus} The populated <code>V1DaemonSetStatus</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1DaemonSetStatus();
            ...
            if (data.hasOwnProperty('conditions')) {
                obj['conditions'] = ApiClient.convertToType(data['conditions'], [V1DaemonSetCondition]);
            }
    ...
    * @member {Array.<module:client/client.models/V1DaemonSetCondition>} conditions
    */

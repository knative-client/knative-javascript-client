...
/**
* The V1beta1LeaseSpec model module.
* @module client/client.models/V1beta1LeaseSpec
* @version 0.1
*/
export default class V1beta1LeaseSpec {
    /**
    * Constructs a new <code>V1beta1LeaseSpec</code>.
    * LeaseSpec is a specification of a Lease.
    * @alias module:client/client.models/V1beta1LeaseSpec
    * @class
    */
    ...
    /**
    * Constructs a <code>V1beta1LeaseSpec</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:client/client.models/V1beta1LeaseSpec} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta1LeaseSpec} The populated <code>V1beta1LeaseSpec</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1beta1LeaseSpec();

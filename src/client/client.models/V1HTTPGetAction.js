...
* @module client/client.models/V1HTTPGetAction
* @version 0.1
*/
export default class V1HTTPGetAction {
    ...
    * @alias module:client/client.models/V1HTTPGetAction
    * @class
    ...
    * @param {module:client/client.models/V1HTTPGetAction} obj Optional instance to populate.
    * @return {module:client/client.models/V1HTTPGetAction} The populated <code>V1HTTPGetAction</code> instance.
    */
    ...
    * @member {Array.<module:client/client.models/V1HTTPHeader>} httpHeaders
    */

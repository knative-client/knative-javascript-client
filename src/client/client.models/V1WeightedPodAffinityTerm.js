...
* @module client/client.models/V1WeightedPodAffinityTerm
* @version 0.1
*/
export default class V1WeightedPodAffinityTerm {
    ...
    * @alias module:client/client.models/V1WeightedPodAffinityTerm
    * @class
    * @param podAffinityTerm {module:client/client.models/V1PodAffinityTerm} Required. A pod affinity term, associated with the corresponding weight.
    ...
    * @param {module:client/client.models/V1WeightedPodAffinityTerm} obj Optional instance to populate.
    * @return {module:client/client.models/V1WeightedPodAffinityTerm} The populated <code>V1WeightedPodAffinityTerm</code> instance.
    */
    ...
    * @member {module:client/client.models/V1PodAffinityTerm} podAffinityTerm
    */

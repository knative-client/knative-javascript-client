...
* @module client/client.models/V1PersistentVolumeClaim
* @version 0.1
*/
export default class V1PersistentVolumeClaim {
    ...
    * @alias module:client/client.models/V1PersistentVolumeClaim
    * @class
    */
    ...
    * @param {module:client/client.models/V1PersistentVolumeClaim} obj Optional instance to populate.
    * @return {module:client/client.models/V1PersistentVolumeClaim} The populated <code>V1PersistentVolumeClaim</code> instance.
    */
    ...
    * @member {module:client/client.models/V1PersistentVolumeClaimSpec} spec
    */
    spec = undefined;
    /**
    * Status represents the current information/status of a persistent volume claim. Read-only. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims
    * @member {module:client/client.models/V1PersistentVolumeClaimStatus} status
    */
    status = undefined;

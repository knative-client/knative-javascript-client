...
* @module client/client.models/V1PodTemplate
* @version 0.1
*/
export default class V1PodTemplate {
    ...
    * @alias module:client/client.models/V1PodTemplate
    * @class
    */
    ...
    * @param {module:client/client.models/V1PodTemplate} obj Optional instance to populate.
    * @return {module:client/client.models/V1PodTemplate} The populated <code>V1PodTemplate</code> instance.
    */

...
* @module client/client.models/V1SecurityContext
* @version 0.1
*/
export default class V1SecurityContext {
    ...
    * @alias module:client/client.models/V1SecurityContext
    * @class
    */
    ...
    * @param {module:client/client.models/V1SecurityContext} obj Optional instance to populate.
    * @return {module:client/client.models/V1SecurityContext} The populated <code>V1SecurityContext</code> instance.
    */
    ...
    * @member {module:client/client.models/V1Capabilities} capabilities
    */

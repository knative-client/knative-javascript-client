...
* @module client/client.models/V1JobCondition
* @version 0.1
*/
export default class V1JobCondition {
    ...
    * @alias module:client/client.models/V1JobCondition
    * @class
    ...
    * @param {module:client/client.models/V1JobCondition} obj Optional instance to populate.
    * @return {module:client/client.models/V1JobCondition} The populated <code>V1JobCondition</code> instance.
    */

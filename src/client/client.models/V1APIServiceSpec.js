...
* @module client/client.models/V1APIServiceSpec
* @version 0.1
*/
export default class V1APIServiceSpec {
    ...
    * @alias module:client/client.models/V1APIServiceSpec
    * @class
    ...
    * @param {module:client/client.models/V1APIServiceSpec} obj Optional instance to populate.
    * @return {module:client/client.models/V1APIServiceSpec} The populated <code>V1APIServiceSpec</code> instance.
    */
    ...
    * @member {module:client/client.models/V1ServiceReference} service
    */
    service = undefined;
    /**

...
* @module client/client.models/V1ResourceFieldSelector
* @version 0.1
*/
export default class V1ResourceFieldSelector {
    ...
    * @alias module:client/client.models/V1ResourceFieldSelector
    * @class
    ...
    * @param {module:client/client.models/V1ResourceFieldSelector} obj Optional instance to populate.
    * @return {module:client/client.models/V1ResourceFieldSelector} The populated <code>V1ResourceFieldSelector</code> instance.
    */

...
* @module client/client.models/V1Service
* @version 0.1
*/
export default class V1Service {
    ...
    * @alias module:client/client.models/V1Service
    * @class
    */
    ...
    * @param {module:client/client.models/V1Service} obj Optional instance to populate.
    * @return {module:client/client.models/V1Service} The populated <code>V1Service</code> instance.
    */
    ...
    * @member {module:client/client.models/V1ServiceSpec} spec
    */
    spec = undefined;
    /**
    * Most recently observed status of the service. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
    * @member {module:client/client.models/V1ServiceStatus} status
    */
    status = undefined;

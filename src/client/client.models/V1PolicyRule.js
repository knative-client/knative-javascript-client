...
/**
* The V1PolicyRule model module.
* @module client/client.models/V1PolicyRule
* @version 0.1
*/
export default class V1PolicyRule {
    /**
    * Constructs a new <code>V1PolicyRule</code>.
    * PolicyRule holds information that describes a policy rule, but does not contain information about who the rule applies to or which namespace the rule applies to.
    * @alias module:client/client.models/V1PolicyRule
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>V1PolicyRule</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:client/client.models/V1PolicyRule} obj Optional instance to populate.
    * @return {module:client/client.models/V1PolicyRule} The populated <code>V1PolicyRule</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1PolicyRule();

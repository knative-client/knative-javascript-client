...
* @module client/client.models/V1Endpoints
* @version 0.1
*/
export default class V1Endpoints {
    ...
    * @alias module:client/client.models/V1Endpoints
    * @class
    */
    ...
    * @param {module:client/client.models/V1Endpoints} obj Optional instance to populate.
    * @return {module:client/client.models/V1Endpoints} The populated <code>V1Endpoints</code> instance.
    */
    ...
    * @member {Array.<module:client/client.models/V1EndpointSubset>} subsets
    */
    subsets = undefined;

...
* @module client/client.models/V1KeyToPath
* @version 0.1
*/
export default class V1KeyToPath {
    ...
    * @alias module:client/client.models/V1KeyToPath
    * @class
    ...
    * @param {module:client/client.models/V1KeyToPath} obj Optional instance to populate.
    * @return {module:client/client.models/V1KeyToPath} The populated <code>V1KeyToPath</code> instance.
    */

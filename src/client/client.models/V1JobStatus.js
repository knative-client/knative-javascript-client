...
* @module client/client.models/V1JobStatus
* @version 0.1
*/
export default class V1JobStatus {
    ...
    * @alias module:client/client.models/V1JobStatus
    * @class
    */
    ...
    * @param {module:client/client.models/V1JobStatus} obj Optional instance to populate.
    * @return {module:client/client.models/V1JobStatus} The populated <code>V1JobStatus</code> instance.
    */
    ...
    * @member {Array.<module:client/client.models/V1JobCondition>} conditions
    */

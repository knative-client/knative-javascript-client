...
* @module client/client.models/V1NodeStatus
* @version 0.1
*/
export default class V1NodeStatus {
    ...
    * @alias module:client/client.models/V1NodeStatus
    * @class
    */
    ...
    * @param {module:client/client.models/V1NodeStatus} obj Optional instance to populate.
    * @return {module:client/client.models/V1NodeStatus} The populated <code>V1NodeStatus</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('config')) {
                obj['config'] = V1NodeConfigStatus.constructFromObject(data['config']);
            }
    ...
    * @member {Array.<module:client/client.models/V1NodeAddress>} addresses
    */
    addresses = undefined;
    /**
    ...
    * @member {Array.<module:client/client.models/V1NodeCondition>} conditions
    */
    conditions = undefined;
    /**
    * Status of the config assigned to the node via the dynamic Kubelet config feature.
    * @member {module:client/client.models/V1NodeConfigStatus} config
    */
    config = undefined;
    /**
    * Endpoints of daemons running on the Node.
    * @member {module:client/client.models/V1NodeDaemonEndpoints} daemonEndpoints
    */
    daemonEndpoints = undefined;
    /**
    * List of container images on this node
    * @member {Array.<module:client/client.models/V1ContainerImage>} images
    */
    images = undefined;
    /**
    * Set of ids/uuids to uniquely identify the node. More info: https://kubernetes.io/docs/concepts/nodes/node/#info
    * @member {module:client/client.models/V1NodeSystemInfo} nodeInfo
    */
    nodeInfo = undefined;
    /**
    ...
    * @member {Array.<module:client/client.models/V1AttachedVolume>} volumesAttached
    */

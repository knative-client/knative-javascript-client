...
* @module client/client.models/V1ConfigMapVolumeSource
* @version 0.1
*/
export default class V1ConfigMapVolumeSource {
    ...
    * @alias module:client/client.models/V1ConfigMapVolumeSource
    * @class
    */
    ...
    * @param {module:client/client.models/V1ConfigMapVolumeSource} obj Optional instance to populate.
    * @return {module:client/client.models/V1ConfigMapVolumeSource} The populated <code>V1ConfigMapVolumeSource</code> instance.
    */

...
* @module client/client.models/V1beta1Eviction
* @version 0.1
*/
export default class V1beta1Eviction {
    ...
    * @alias module:client/client.models/V1beta1Eviction
    * @class
    */
    ...
    * @param {module:client/client.models/V1beta1Eviction} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta1Eviction} The populated <code>V1beta1Eviction</code> instance.
    */
    ...
    * @member {module:client/client.models/V1DeleteOptions} deleteOptions
    */

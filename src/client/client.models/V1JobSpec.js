...
* @module client/client.models/V1JobSpec
* @version 0.1
*/
export default class V1JobSpec {
    ...
    * @alias module:client/client.models/V1JobSpec
    * @class
    * @param template {module:client/client.models/V1PodTemplateSpec} Describes the pod that will be created when executing a job. More info: https://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/
    */
    ...
    * @param {module:client/client.models/V1JobSpec} obj Optional instance to populate.
    * @return {module:client/client.models/V1JobSpec} The populated <code>V1JobSpec</code> instance.
    */

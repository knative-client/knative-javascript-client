...
* @module client/client.models/V1beta2StatefulSetUpdateStrategy
* @version 0.1
*/
export default class V1beta2StatefulSetUpdateStrategy {
    ...
    * @alias module:client/client.models/V1beta2StatefulSetUpdateStrategy
    * @class
    */
    ...
    * @param {module:client/client.models/V1beta2StatefulSetUpdateStrategy} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta2StatefulSetUpdateStrategy} The populated <code>V1beta2StatefulSetUpdateStrategy</code> instance.
    */
    ...
    * @member {module:client/client.models/V1beta2RollingUpdateStatefulSetStrategy} rollingUpdate
    */

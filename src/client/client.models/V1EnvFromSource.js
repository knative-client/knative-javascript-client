...
* @module client/client.models/V1EnvFromSource
* @version 0.1
*/
export default class V1EnvFromSource {
    ...
    * @alias module:client/client.models/V1EnvFromSource
    * @class
    */
    ...
    * @param {module:client/client.models/V1EnvFromSource} obj Optional instance to populate.
    * @return {module:client/client.models/V1EnvFromSource} The populated <code>V1EnvFromSource</code> instance.
    */
    ...
    * @member {module:client/client.models/V1ConfigMapEnvSource} configMapRef
    */
    ...
    * @member {module:client/client.models/V1SecretEnvSource} secretRef
    */
    secretRef = undefined;

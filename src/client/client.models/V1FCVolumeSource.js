...
* @module client/client.models/V1FCVolumeSource
* @version 0.1
*/
export default class V1FCVolumeSource {
    ...
    * @alias module:client/client.models/V1FCVolumeSource
    * @class
    */
    ...
    * @param {module:client/client.models/V1FCVolumeSource} obj Optional instance to populate.
    * @return {module:client/client.models/V1FCVolumeSource} The populated <code>V1FCVolumeSource</code> instance.
    */

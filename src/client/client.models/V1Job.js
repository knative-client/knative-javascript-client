...
* @module client/client.models/V1Job
* @version 0.1
*/
export default class V1Job {
    ...
    * @alias module:client/client.models/V1Job
    * @class
    */
    ...
    * @param {module:client/client.models/V1Job} obj Optional instance to populate.
    * @return {module:client/client.models/V1Job} The populated <code>V1Job</code> instance.
    */
    ...
    * @member {module:client/client.models/V1JobStatus} status
    */
    status = undefined;

...
* @module client/client.models/V1ContainerPort
* @version 0.1
*/
export default class V1ContainerPort {
    ...
    * @alias module:client/client.models/V1ContainerPort
    * @class
    ...
    * @param {module:client/client.models/V1ContainerPort} obj Optional instance to populate.
    * @return {module:client/client.models/V1ContainerPort} The populated <code>V1ContainerPort</code> instance.
    */

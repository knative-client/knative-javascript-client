...
* @module client/client.models/V1beta1ControllerRevisionList
* @version 0.1
*/
export default class V1beta1ControllerRevisionList {
    ...
    * @alias module:client/client.models/V1beta1ControllerRevisionList
    * @class
    * @param items {Array.<module:client/client.models/V1beta1ControllerRevision>} Items is the list of ControllerRevisions
    */
    ...
    * @param {module:client/client.models/V1beta1ControllerRevisionList} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta1ControllerRevisionList} The populated <code>V1beta1ControllerRevisionList</code> instance.
    */
    ...
    * @member {Array.<module:client/client.models/V1beta1ControllerRevision>} items
    */
    items = undefined;
    /**

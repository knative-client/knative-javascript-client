...
* @module client/client.models/V1ServiceSpec
* @version 0.1
*/
export default class V1ServiceSpec {
    ...
    * @alias module:client/client.models/V1ServiceSpec
    * @class
    */
    ...
    * @param {module:client/client.models/V1ServiceSpec} obj Optional instance to populate.
    * @return {module:client/client.models/V1ServiceSpec} The populated <code>V1ServiceSpec</code> instance.
    */
    ...
    * @member {Array.<module:client/client.models/V1ServicePort>} ports
    */
    ports = undefined;
    /**
    ...
    * @member {module:client/client.models/V1SessionAffinityConfig} sessionAffinityConfig
    */

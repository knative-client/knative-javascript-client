...
* @module client/client.models/V1HorizontalPodAutoscalerSpec
* @version 0.1
*/
export default class V1HorizontalPodAutoscalerSpec {
    ...
    * @alias module:client/client.models/V1HorizontalPodAutoscalerSpec
    * @class
    ...
    * @param scaleTargetRef {module:client/client.models/V1CrossVersionObjectReference} reference to scaled resource; horizontal pod autoscaler will learn the current resource consumption and will set the desired number of pods by using its Scale subresource.
    */
    ...
    * @param {module:client/client.models/V1HorizontalPodAutoscalerSpec} obj Optional instance to populate.
    * @return {module:client/client.models/V1HorizontalPodAutoscalerSpec} The populated <code>V1HorizontalPodAutoscalerSpec</code> instance.
    */
    ...
    * @member {module:client/client.models/V1CrossVersionObjectReference} scaleTargetRef
    */

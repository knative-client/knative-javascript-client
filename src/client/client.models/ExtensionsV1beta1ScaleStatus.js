...
* @module client/client.models/ExtensionsV1beta1ScaleStatus
* @version 0.1
*/
export default class ExtensionsV1beta1ScaleStatus {
    ...
    * @alias module:client/client.models/ExtensionsV1beta1ScaleStatus
    * @class
    ...
    * @param {module:client/client.models/ExtensionsV1beta1ScaleStatus} obj Optional instance to populate.
    * @return {module:client/client.models/ExtensionsV1beta1ScaleStatus} The populated <code>ExtensionsV1beta1ScaleStatus</code> instance.
    */

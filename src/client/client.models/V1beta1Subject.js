...
* @module client/client.models/V1beta1Subject
* @version 0.1
*/
export default class V1beta1Subject {
    ...
    * @alias module:client/client.models/V1beta1Subject
    * @class
    ...
    * @param {module:client/client.models/V1beta1Subject} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta1Subject} The populated <code>V1beta1Subject</code> instance.
    */

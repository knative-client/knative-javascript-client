...
* @module client/client.models/V1LabelSelectorRequirement
* @version 0.1
*/
export default class V1LabelSelectorRequirement {
    ...
    * @alias module:client/client.models/V1LabelSelectorRequirement
    * @class
    ...
    * @param {module:client/client.models/V1LabelSelectorRequirement} obj Optional instance to populate.
    * @return {module:client/client.models/V1LabelSelectorRequirement} The populated <code>V1LabelSelectorRequirement</code> instance.
    */

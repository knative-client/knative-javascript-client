...
* @module client/client.models/V1beta1StatefulSetSpec
* @version 0.1
*/
export default class V1beta1StatefulSetSpec {
    /**
    * Constructs a new <code>V1beta1StatefulSetSpec</code>.
    * A StatefulSetSpec is the specification of a StatefulSet.
    * @alias module:client/client.models/V1beta1StatefulSetSpec
    * @class
    ...
    * @param {module:client/client.models/V1beta1StatefulSetSpec} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta1StatefulSetSpec} The populated <code>V1beta1StatefulSetSpec</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1beta1StatefulSetSpec();
            ...
            if (data.hasOwnProperty('updateStrategy')) {
                obj['updateStrategy'] = V1beta1StatefulSetUpdateStrategy.constructFromObject(data['updateStrategy']);
            }
    ...
    * @member {module:client/client.models/V1beta1StatefulSetUpdateStrategy} updateStrategy
    */

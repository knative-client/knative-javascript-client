...
* @module client/client.models/V1Status
* @version 0.1
*/
export default class V1Status {
    ...
    * @alias module:client/client.models/V1Status
    * @class
    */
    ...
    * @param {module:client/client.models/V1Status} obj Optional instance to populate.
    * @return {module:client/client.models/V1Status} The populated <code>V1Status</code> instance.
    */

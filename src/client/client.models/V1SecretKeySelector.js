...
* @module client/client.models/V1SecretKeySelector
* @version 0.1
*/
export default class V1SecretKeySelector {
    ...
    * @alias module:client/client.models/V1SecretKeySelector
    * @class
    ...
    * @param {module:client/client.models/V1SecretKeySelector} obj Optional instance to populate.
    * @return {module:client/client.models/V1SecretKeySelector} The populated <code>V1SecretKeySelector</code> instance.
    */

...
* @module client/client.models/V1ScaleIOPersistentVolumeSource
* @version 0.1
*/
export default class V1ScaleIOPersistentVolumeSource {
    ...
    * @alias module:client/client.models/V1ScaleIOPersistentVolumeSource
    * @class
    * @param gateway {String} The host address of the ScaleIO API Gateway.
    * @param secretRef {module:client/client.models/V1SecretReference} SecretRef references to the secret for ScaleIO user and other sensitive information. If this is not provided, Login operation will fail.
    ...
    * @param {module:client/client.models/V1ScaleIOPersistentVolumeSource} obj Optional instance to populate.
    * @return {module:client/client.models/V1ScaleIOPersistentVolumeSource} The populated <code>V1ScaleIOPersistentVolumeSource</code> instance.
    */

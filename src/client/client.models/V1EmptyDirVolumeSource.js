...
* @module client/client.models/V1EmptyDirVolumeSource
* @version 0.1
*/
export default class V1EmptyDirVolumeSource {
    ...
    * @alias module:client/client.models/V1EmptyDirVolumeSource
    * @class
    */
    ...
    * @param {module:client/client.models/V1EmptyDirVolumeSource} obj Optional instance to populate.
    * @return {module:client/client.models/V1EmptyDirVolumeSource} The populated <code>V1EmptyDirVolumeSource</code> instance.
    */

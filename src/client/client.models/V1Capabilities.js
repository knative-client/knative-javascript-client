...
* @module client/client.models/V1Capabilities
* @version 0.1
*/
export default class V1Capabilities {
    ...
    * @alias module:client/client.models/V1Capabilities
    * @class
    */
    ...
    * @param {module:client/client.models/V1Capabilities} obj Optional instance to populate.
    * @return {module:client/client.models/V1Capabilities} The populated <code>V1Capabilities</code> instance.
    */

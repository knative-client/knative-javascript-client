...
* @module client/client.models/V1NodeSystemInfo
* @version 0.1
*/
export default class V1NodeSystemInfo {
    ...
    * @alias module:client/client.models/V1NodeSystemInfo
    * @class
    ...
    * @param {module:client/client.models/V1NodeSystemInfo} obj Optional instance to populate.
    * @return {module:client/client.models/V1NodeSystemInfo} The populated <code>V1NodeSystemInfo</code> instance.
    */

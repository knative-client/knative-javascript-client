...
* @module client/client.models/V1LimitRange
* @version 0.1
*/
export default class V1LimitRange {
    ...
    * @alias module:client/client.models/V1LimitRange
    * @class
    */
    ...
    * @param {module:client/client.models/V1LimitRange} obj Optional instance to populate.
    * @return {module:client/client.models/V1LimitRange} The populated <code>V1LimitRange</code> instance.
    */
    ...
    * @member {module:client/client.models/V1LimitRangeSpec} spec
    */
    spec = undefined;

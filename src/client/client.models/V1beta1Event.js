...
* @module client/client.models/V1beta1Event
* @version 0.1
*/
export default class V1beta1Event {
    ...
    * @alias module:client/client.models/V1beta1Event
    * @class
    ...
    * @param {module:client/client.models/V1beta1Event} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta1Event} The populated <code>V1beta1Event</code> instance.
    */
    ...
    */
    ...
    /**
    * Deprecated field assuring backward compatibility with core.v1 Event type
    * @member {module:client/client.models/V1EventSource} deprecatedSource
    */
    ...
    * @member {module:client/client.models/V1ObjectReference} regarding
    */
    regarding = undefined;
    /**
    ...
    * @member {module:client/client.models/V1beta1EventSeries} series
    */
    series = undefined;
    /**

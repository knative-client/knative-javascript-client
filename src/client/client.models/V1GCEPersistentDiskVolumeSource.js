...
* @module client/client.models/V1GCEPersistentDiskVolumeSource
* @version 0.1
*/
export default class V1GCEPersistentDiskVolumeSource {
    ...
    * @alias module:client/client.models/V1GCEPersistentDiskVolumeSource
    * @class
    ...
    * @param {module:client/client.models/V1GCEPersistentDiskVolumeSource} obj Optional instance to populate.
    * @return {module:client/client.models/V1GCEPersistentDiskVolumeSource} The populated <code>V1GCEPersistentDiskVolumeSource</code> instance.
    */

...
* @module client/client.models/V1beta1RoleRef
* @version 0.1
*/
export default class V1beta1RoleRef {
    ...
    * @alias module:client/client.models/V1beta1RoleRef
    * @class
    ...
    * @param {module:client/client.models/V1beta1RoleRef} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta1RoleRef} The populated <code>V1beta1RoleRef</code> instance.
    */

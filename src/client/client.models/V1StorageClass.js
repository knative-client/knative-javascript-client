...
* @module client/client.models/V1StorageClass
* @version 0.1
*/
export default class V1StorageClass {
    /**
    * Constructs a new <code>V1StorageClass</code>.
    * StorageClass describes the parameters for a class of storage for which PersistentVolumes can be dynamically provisioned.  StorageClasses are non-namespaced; the name of the storage class according to etcd is in ObjectMeta.Name.
    * @alias module:client/client.models/V1StorageClass
    * @class
    ...
    * @param {module:client/client.models/V1StorageClass} obj Optional instance to populate.
    * @return {module:client/client.models/V1StorageClass} The populated <code>V1StorageClass</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1StorageClass();
            ...
            if (data.hasOwnProperty('allowedTopologies')) {
                obj['allowedTopologies'] = ApiClient.convertToType(data['allowedTopologies'], [V1TopologySelectorTerm]);
            }
    ...
    * @member {Array.<module:client/client.models/V1TopologySelectorTerm>} allowedTopologies
    */
    allowedTopologies = undefined;
    /**

...
* @module client/client.models/V1ObjectReference
* @version 0.1
*/
export default class V1ObjectReference {
    ...
    * @alias module:client/client.models/V1ObjectReference
    * @class
    */
    ...
    * @param {module:client/client.models/V1ObjectReference} obj Optional instance to populate.
    * @return {module:client/client.models/V1ObjectReference} The populated <code>V1ObjectReference</code> instance.
    */

...
* @module client/client.models/V1SelfSubjectAccessReviewSpec
* @version 0.1
*/
export default class V1SelfSubjectAccessReviewSpec {
    ...
    * @alias module:client/client.models/V1SelfSubjectAccessReviewSpec
    * @class
    */
    ...
    * @param {module:client/client.models/V1SelfSubjectAccessReviewSpec} obj Optional instance to populate.
    * @return {module:client/client.models/V1SelfSubjectAccessReviewSpec} The populated <code>V1SelfSubjectAccessReviewSpec</code> instance.
    */
    ...
    * @member {module:client/client.models/V1NonResourceAttributes} nonResourceAttributes
    */
    nonResourceAttributes = undefined;
    /**
    * ResourceAuthorizationAttributes describes information for a resource access request
    * @member {module:client/client.models/V1ResourceAttributes} resourceAttributes
    */

...
* @module client/client.models/V1beta1StatefulSet
* @version 0.1
*/
export default class V1beta1StatefulSet {
    /**
    ...
    * @alias module:client/client.models/V1beta1StatefulSet
    * @class
    */
    ...
    * @param {module:client/client.models/V1beta1StatefulSet} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta1StatefulSet} The populated <code>V1beta1StatefulSet</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1beta1StatefulSet();
    ...
    * @member {module:client/client.models/V1beta1StatefulSetSpec} spec
    */
    spec = undefined;
    /**
    * Status is the current status of Pods in this StatefulSet. This data may be out of date by some window of time.
    * @member {module:client/client.models/V1beta1StatefulSetStatus} status
    */
    status = undefined;

...
* @module client/client.models/V1beta1SubjectAccessReviewStatus
* @version 0.1
*/
export default class V1beta1SubjectAccessReviewStatus {
    ...
    * @alias module:client/client.models/V1beta1SubjectAccessReviewStatus
    * @class
    ...
    * @param {module:client/client.models/V1beta1SubjectAccessReviewStatus} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta1SubjectAccessReviewStatus} The populated <code>V1beta1SubjectAccessReviewStatus</code> instance.
    */

...
* @module client/client.models/V1ReplicationControllerStatus
* @version 0.1
*/
export default class V1ReplicationControllerStatus {
    ...
    * @alias module:client/client.models/V1ReplicationControllerStatus
    * @class
    ...
    * @param {module:client/client.models/V1ReplicationControllerStatus} obj Optional instance to populate.
    * @return {module:client/client.models/V1ReplicationControllerStatus} The populated <code>V1ReplicationControllerStatus</code> instance.
    */
    ...
    * @member {Array.<module:client/client.models/V1ReplicationControllerCondition>} conditions
    */

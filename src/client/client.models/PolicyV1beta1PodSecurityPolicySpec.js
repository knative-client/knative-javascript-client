...
* @module client/client.models/PolicyV1beta1PodSecurityPolicySpec
* @version 0.1
*/
export default class PolicyV1beta1PodSecurityPolicySpec {
    ...
    * @alias module:client/client.models/PolicyV1beta1PodSecurityPolicySpec
    * @class
    * @param fsGroup {module:client/client.models/PolicyV1beta1FSGroupStrategyOptions} fsGroup is the strategy that will dictate what fs group is used by the SecurityContext.
    * @param runAsUser {module:client/client.models/PolicyV1beta1RunAsUserStrategyOptions} runAsUser is the strategy that will dictate the allowable RunAsUser values that may be set.
    * @param seLinux {module:client/client.models/PolicyV1beta1SELinuxStrategyOptions} seLinux is the strategy that will dictate the allowable labels that may be set.
    * @param supplementalGroups {module:client/client.models/PolicyV1beta1SupplementalGroupsStrategyOptions} supplementalGroups is the strategy that will dictate what supplemental groups are used by the SecurityContext.
    */
    ...
    * @param {module:client/client.models/PolicyV1beta1PodSecurityPolicySpec} obj Optional instance to populate.
    * @return {module:client/client.models/PolicyV1beta1PodSecurityPolicySpec} The populated <code>PolicyV1beta1PodSecurityPolicySpec</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('allowedCSIDrivers')) {
                obj['allowedCSIDrivers'] = ApiClient.convertToType(data['allowedCSIDrivers'], [PolicyV1beta1AllowedCSIDriver]);
            }
            ...
            if (data.hasOwnProperty('runAsGroup')) {
                obj['runAsGroup'] = PolicyV1beta1RunAsGroupStrategyOptions.constructFromObject(data['runAsGroup']);
            }
    ...
    * @member {Array.<module:client/client.models/PolicyV1beta1AllowedCSIDriver>} allowedCSIDrivers
    */
    ...
    * @member {Array.<module:client/client.models/PolicyV1beta1AllowedFlexVolume>} allowedFlexVolumes
    */
    allowedFlexVolumes = undefined;
    /**
    * allowedHostPaths is a white list of allowed host paths. Empty indicates that all host paths may be used.
    * @member {Array.<module:client/client.models/PolicyV1beta1AllowedHostPath>} allowedHostPaths
    */
    ...
    * @member {module:client/client.models/PolicyV1beta1FSGroupStrategyOptions} fsGroup
    */
    fsGroup = undefined;
    /**
    ...
    * @member {Array.<module:client/client.models/PolicyV1beta1HostPortRange>} hostPorts
    */
    hostPorts = undefined;
    /**
    ...
    * @member {module:client/client.models/PolicyV1beta1RunAsGroupStrategyOptions} runAsGroup
    */
    runAsGroup = undefined;
    /**
    * runAsUser is the strategy that will dictate the allowable RunAsUser values that may be set.
    * @member {module:client/client.models/PolicyV1beta1RunAsUserStrategyOptions} runAsUser
    */
    runAsUser = undefined;
    /**
    * seLinux is the strategy that will dictate the allowable labels that may be set.
    * @member {module:client/client.models/PolicyV1beta1SELinuxStrategyOptions} seLinux
    */
    seLinux = undefined;
    /**
    * supplementalGroups is the strategy that will dictate what supplemental groups are used by the SecurityContext.
    * @member {module:client/client.models/PolicyV1beta1SupplementalGroupsStrategyOptions} supplementalGroups
    */

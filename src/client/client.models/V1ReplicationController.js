...
* @module client/client.models/V1ReplicationController
* @version 0.1
*/
export default class V1ReplicationController {
    /**
    * Constructs a new <code>V1ReplicationController</code>.
    * ReplicationController represents the configuration of a replication controller.
    * @alias module:client/client.models/V1ReplicationController
    * @class
    */
    ...
    * @param {module:client/client.models/V1ReplicationController} obj Optional instance to populate.
    * @return {module:client/client.models/V1ReplicationController} The populated <code>V1ReplicationController</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1ReplicationController();
    ...
    * @member {module:client/client.models/V1ReplicationControllerSpec} spec
    */
    spec = undefined;
    /**
    * Status is the most recently observed status of the replication controller. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
    * @member {module:client/client.models/V1ReplicationControllerStatus} status
    */
    status = undefined;

...
* @module client/client.models/VersionInfo
* @version 0.1
*/
export default class VersionInfo {
    ...
    * @alias module:client/client.models/VersionInfo
    * @class
    ...
    * @param {module:client/client.models/VersionInfo} obj Optional instance to populate.
    * @return {module:client/client.models/VersionInfo} The populated <code>VersionInfo</code> instance.
    */

...
* @module client/client.models/V1ServiceAccount
* @version 0.1
*/
export default class V1ServiceAccount {
    ...
    * @alias module:client/client.models/V1ServiceAccount
    * @class
    */
    ...
    * @param {module:client/client.models/V1ServiceAccount} obj Optional instance to populate.
    * @return {module:client/client.models/V1ServiceAccount} The populated <code>V1ServiceAccount</code> instance.
    */
    ...
    * @member {Array.<module:client/client.models/V1ObjectReference>} secrets
    */
    secrets = undefined;

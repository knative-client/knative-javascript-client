...
/**
* The V1beta2StatefulSetStatus model module.
* @module client/client.models/V1beta2StatefulSetStatus
* @version 0.1
*/
export default class V1beta2StatefulSetStatus {
    /**
    * Constructs a new <code>V1beta2StatefulSetStatus</code>.
    * StatefulSetStatus represents the current state of a StatefulSet.
    * @alias module:client/client.models/V1beta2StatefulSetStatus
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>V1beta2StatefulSetStatus</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:client/client.models/V1beta2StatefulSetStatus} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta2StatefulSetStatus} The populated <code>V1beta2StatefulSetStatus</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1beta2StatefulSetStatus();
            ...
            if (data.hasOwnProperty('conditions')) {
                obj['conditions'] = ApiClient.convertToType(data['conditions'], [V1beta2StatefulSetCondition]);
            }
    ...
    * @member {Array.<module:client/client.models/V1beta2StatefulSetCondition>} conditions
    */

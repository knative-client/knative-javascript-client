...
* @module client/client.models/V1beta1StatefulSetStatus
* @version 0.1
*/
export default class V1beta1StatefulSetStatus {
    /**
    * Constructs a new <code>V1beta1StatefulSetStatus</code>.
    * StatefulSetStatus represents the current state of a StatefulSet.
    * @alias module:client/client.models/V1beta1StatefulSetStatus
    * @class
    ...
    * @param {module:client/client.models/V1beta1StatefulSetStatus} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta1StatefulSetStatus} The populated <code>V1beta1StatefulSetStatus</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1beta1StatefulSetStatus();
            ...
            if (data.hasOwnProperty('conditions')) {
                obj['conditions'] = ApiClient.convertToType(data['conditions'], [V1beta1StatefulSetCondition]);
            }
    ...
    * @member {Array.<module:client/client.models/V1beta1StatefulSetCondition>} conditions
    */

...
* @module client/client.models/V1SubjectRulesReviewStatus
* @version 0.1
*/
export default class V1SubjectRulesReviewStatus {
    ...
    * @alias module:client/client.models/V1SubjectRulesReviewStatus
    * @class
    ...
    * @param nonResourceRules {Array.<module:client/client.models/V1NonResourceRule>} NonResourceRules is the list of actions the subject is allowed to perform on non-resources. The list ordering isn't significant, may contain duplicates, and possibly be incomplete.
    * @param resourceRules {Array.<module:client/client.models/V1ResourceRule>} ResourceRules is the list of actions the subject is allowed to perform on resources. The list ordering isn't significant, may contain duplicates, and possibly be incomplete.
    */
    ...
    * @param {module:client/client.models/V1SubjectRulesReviewStatus} obj Optional instance to populate.
    * @return {module:client/client.models/V1SubjectRulesReviewStatus} The populated <code>V1SubjectRulesReviewStatus</code> instance.
    */
    ...
    * @member {Array.<module:client/client.models/V1NonResourceRule>} nonResourceRules
    */
    nonResourceRules = undefined;
    /**
    * ResourceRules is the list of actions the subject is allowed to perform on resources. The list ordering isn't significant, may contain duplicates, and possibly be incomplete.
    * @member {Array.<module:client/client.models/V1ResourceRule>} resourceRules
    */

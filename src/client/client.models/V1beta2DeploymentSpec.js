...
/**
* The V1beta2DeploymentSpec model module.
* @module client/client.models/V1beta2DeploymentSpec
* @version 0.1
*/
export default class V1beta2DeploymentSpec {
    /**
    * Constructs a new <code>V1beta2DeploymentSpec</code>.
    * DeploymentSpec is the specification of the desired behavior of the Deployment.
    * @alias module:client/client.models/V1beta2DeploymentSpec
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>V1beta2DeploymentSpec</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:client/client.models/V1beta2DeploymentSpec} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta2DeploymentSpec} The populated <code>V1beta2DeploymentSpec</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1beta2DeploymentSpec();
            ...
            if (data.hasOwnProperty('strategy')) {
                obj['strategy'] = V1beta2DeploymentStrategy.constructFromObject(data['strategy']);
            }
    ...
    * @member {module:client/client.models/V1beta2DeploymentStrategy} strategy
    */
    strategy = undefined;
    /**

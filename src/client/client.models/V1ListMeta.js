...
* @module client/client.models/V1ListMeta
* @version 0.1
*/
export default class V1ListMeta {
    ...
    * @alias module:client/client.models/V1ListMeta
    * @class
    */
    ...
    * @param {module:client/client.models/V1ListMeta} obj Optional instance to populate.
    * @return {module:client/client.models/V1ListMeta} The populated <code>V1ListMeta</code> instance.
    */

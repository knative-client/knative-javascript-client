...
* @module client/client.models/V1StatefulSetList
* @version 0.1
*/
export default class V1StatefulSetList {
    ...
    * @alias module:client/client.models/V1StatefulSetList
    * @class
    * @param items {Array.<module:client/client.models/V1StatefulSet>} 
    */
    ...
    * @param {module:client/client.models/V1StatefulSetList} obj Optional instance to populate.
    * @return {module:client/client.models/V1StatefulSetList} The populated <code>V1StatefulSetList</code> instance.
    */
    ...
    */
    ...
    /**
    * @member {Array.<module:client/client.models/V1StatefulSet>} items
    */
    items = undefined;
    /**

...
* @module client/client.models/V1VsphereVirtualDiskVolumeSource
* @version 0.1
*/
export default class V1VsphereVirtualDiskVolumeSource {
    ...
    * @alias module:client/client.models/V1VsphereVirtualDiskVolumeSource
    * @class
    ...
    * @param {module:client/client.models/V1VsphereVirtualDiskVolumeSource} obj Optional instance to populate.
    * @return {module:client/client.models/V1VsphereVirtualDiskVolumeSource} The populated <code>V1VsphereVirtualDiskVolumeSource</code> instance.
    */

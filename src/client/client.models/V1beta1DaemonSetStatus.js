...
* @module client/client.models/V1beta1DaemonSetStatus
* @version 0.1
*/
export default class V1beta1DaemonSetStatus {
    /**
    * Constructs a new <code>V1beta1DaemonSetStatus</code>.
    * DaemonSetStatus represents the current status of a daemon set.
    * @alias module:client/client.models/V1beta1DaemonSetStatus
    * @class
    ...
    * @param {module:client/client.models/V1beta1DaemonSetStatus} obj Optional instance to populate.
    * @return {module:client/client.models/V1beta1DaemonSetStatus} The populated <code>V1beta1DaemonSetStatus</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1beta1DaemonSetStatus();
            ...
            if (data.hasOwnProperty('conditions')) {
                obj['conditions'] = ApiClient.convertToType(data['conditions'], [V1beta1DaemonSetCondition]);
            }
    ...
    * @member {Array.<module:client/client.models/V1beta1DaemonSetCondition>} conditions
    */

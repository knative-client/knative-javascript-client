...
let apiInstance = new KubernetesJsClient.RbacAuthorization_v1beta1Api();

let body = new KubernetesJsClient.V1beta1ClusterRole(); // V1beta1ClusterRole | 
...
let body = new KubernetesJsClient.V1beta1ClusterRoleBinding(); // V1beta1ClusterRoleBinding | 
...
let body = new KubernetesJsClient.V1beta1Role(); // V1beta1Role | 
...
let body = new KubernetesJsClient.V1beta1RoleBinding(); // V1beta1RoleBinding | 

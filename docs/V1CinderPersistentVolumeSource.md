# KubernetesJsClient.V1CinderPersistentVolumeSource
...
**secretRef** | [**V1SecretReference**](V1SecretReference.md) | Optional: points to a secret object containing parameters used to connect to OpenStack. | [optional] 

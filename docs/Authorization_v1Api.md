...
let apiInstance = new KubernetesJsClient.Authorization_v1Api();

let namespace = "namespace_example"; // String | object name and auth scope, such as for teams and projects

let body = new KubernetesJsClient.V1LocalSubjectAccessReview(); // V1LocalSubjectAccessReview | 
...
let body = new KubernetesJsClient.V1SelfSubjectAccessReview(); // V1SelfSubjectAccessReview | 
...
> V1SelfSubjectRulesReview createSelfSubjectRulesReview(body, opts)
...
let body = new KubernetesJsClient.V1SelfSubjectRulesReview(); // V1SelfSubjectRulesReview | 
...
let body = new KubernetesJsClient.V1SubjectAccessReview(); // V1SubjectAccessReview | 

# KubernetesJsClient.Networking_v1Api
...
> V1NetworkPolicy createNamespacedNetworkPolicy(namespacebody, opts)
...
let apiInstance = new KubernetesJsClient.Networking_v1Api();

let namespace = "namespace_example"; // String | object name and auth scope, such as for teams and projects

let body = new KubernetesJsClient.V1NetworkPolicy(); // V1NetworkPolicy | 
...
> V1NetworkPolicyList listNamespacedNetworkPolicy(namespace, opts)
...
> V1NetworkPolicyList listNetworkPolicyForAllNamespaces(opts)
...
> V1NetworkPolicy patchNamespacedNetworkPolicy(name, namespace, body, opts)
...
> V1NetworkPolicy readNamespacedNetworkPolicy(name, namespace, , opts)
...
> V1NetworkPolicy replaceNamespacedNetworkPolicy(name, namespace, body, opts)

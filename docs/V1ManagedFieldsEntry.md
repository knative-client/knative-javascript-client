# KubernetesJsClient.V1ManagedFieldsEntry
...
**time** | **Date** | Time is timestamp of when these fields were set. It should always be empty if Operation is &#39;Apply&#39; | [optional] 

...
> V1beta1ControllerRevision createNamespacedControllerRevision(namespacebody, opts)
...
let apiInstance = new KubernetesJsClient.Apps_v1beta1Api();

let namespace = "namespace_example"; // String | object name and auth scope, such as for teams and projects

let body = new KubernetesJsClient.V1beta1ControllerRevision(); // V1beta1ControllerRevision | 
...
let body = new KubernetesJsClient.AppsV1beta1Deployment(); // AppsV1beta1Deployment | 
...
let body = new KubernetesJsClient.AppsV1beta1DeploymentRollback(); // AppsV1beta1DeploymentRollback | 
...
let body = new KubernetesJsClient.V1beta1StatefulSet(); // V1beta1StatefulSet | 
...
> V1beta1ControllerRevisionList listControllerRevisionForAllNamespaces(opts)
...
> V1beta1ControllerRevisionList listNamespacedControllerRevision(namespace, opts)
...
> V1beta1ControllerRevision patchNamespacedControllerRevision(name, namespace, body, opts)
...
> AppsV1beta1Scale patchNamespacedDeploymentScale(name, namespace, body, opts)
...
> AppsV1beta1Scale patchNamespacedStatefulSetScale(name, namespace, body, opts)
...
> V1beta1ControllerRevision readNamespacedControllerRevision(name, namespace, , opts)
...
> AppsV1beta1Scale readNamespacedDeploymentScale(name, namespace, , opts)
...
> AppsV1beta1Scale readNamespacedStatefulSetScale(name, namespace, , opts)
...
> V1beta1ControllerRevision replaceNamespacedControllerRevision(name, namespace, body, opts)
...
> AppsV1beta1Scale replaceNamespacedDeploymentScale(name, namespace, body, opts)
...
let body = new KubernetesJsClient.AppsV1beta1Scale(); // AppsV1beta1Scale | 
...
> AppsV1beta1Scale replaceNamespacedStatefulSetScale(name, namespace, body, opts)

# KubernetesJsClient.Scheduling_v1beta1Api

All URIs are relative to *https://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**createPriorityClass**](Scheduling_v1beta1Api.md#createPriorityClass) | **POST** /apis/scheduling.k8s.io/v1beta1/priorityclasses | 
[**deleteCollectionPriorityClass**](Scheduling_v1beta1Api.md#deleteCollectionPriorityClass) | **DELETE** /apis/scheduling.k8s.io/v1beta1/priorityclasses | 
[**deletePriorityClass**](Scheduling_v1beta1Api.md#deletePriorityClass) | **DELETE** /apis/scheduling.k8s.io/v1beta1/priorityclasses/{name} | 
[**getAPIResources**](Scheduling_v1beta1Api.md#getAPIResources) | **GET** /apis/scheduling.k8s.io/v1beta1/ | 
[**listPriorityClass**](Scheduling_v1beta1Api.md#listPriorityClass) | **GET** /apis/scheduling.k8s.io/v1beta1/priorityclasses | 
[**patchPriorityClass**](Scheduling_v1beta1Api.md#patchPriorityClass) | **PATCH** /apis/scheduling.k8s.io/v1beta1/priorityclasses/{name} | 
[**readPriorityClass**](Scheduling_v1beta1Api.md#readPriorityClass) | **GET** /apis/scheduling.k8s.io/v1beta1/priorityclasses/{name} | 
[**replacePriorityClass**](Scheduling_v1beta1Api.md#replacePriorityClass) | **PUT** /apis/scheduling.k8s.io/v1beta1/priorityclasses/{name} | 


<a name="createPriorityClass"></a>
# **createPriorityClass**
> V1beta1PriorityClass createPriorityClass(body, opts)
...
let apiInstance = new KubernetesJsClient.Scheduling_v1beta1Api();

let body = new KubernetesJsClient.V1beta1PriorityClass(); // V1beta1PriorityClass | 
...
apiInstance.createPriorityClass(body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> V1Status deleteCollectionPriorityClass(opts)
...
apiInstance.deleteCollectionPriorityClass(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
# **deletePriorityClass**
> V1Status deletePriorityClass(name, , opts)
...
let name = "name_example"; // String | name of the PriorityClass
...
apiInstance.deletePriorityClass(name, , opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
# **listPriorityClass**
> V1beta1PriorityClassList listPriorityClass(opts)
...
apiInstance.listPriorityClass(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
# **patchPriorityClass**
> V1beta1PriorityClass patchPriorityClass(name, body, opts)
...
apiInstance.patchPriorityClass(name, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
# **readPriorityClass**
> V1beta1PriorityClass readPriorityClass(name, , opts)
...
apiInstance.readPriorityClass(name, , opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> V1beta1PriorityClass replacePriorityClass(name, body, opts)
...
apiInstance.replacePriorityClass(name, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);

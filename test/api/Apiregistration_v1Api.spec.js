...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.Apiregistration_v1Api();
  });
  ...
  describe('Apiregistration_v1Api', function() {
    ...
    describe('patchAPIServiceStatus', function() {
      it('should call patchAPIServiceStatus successfully', function(done) {
        //uncomment below and update the code to test patchAPIServiceStatus
        //instance.patchAPIServiceStatus(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('readAPIServiceStatus', function() {
      it('should call readAPIServiceStatus successfully', function(done) {
        //uncomment below and update the code to test readAPIServiceStatus
        //instance.readAPIServiceStatus(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.Storage_v1Api();
  });
  ...
  describe('Storage_v1Api', function() {
    ...
    describe('patchVolumeAttachmentStatus', function() {
      it('should call patchVolumeAttachmentStatus successfully', function(done) {
        //uncomment below and update the code to test patchVolumeAttachmentStatus
        //instance.patchVolumeAttachmentStatus(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('readVolumeAttachmentStatus', function() {
      it('should call readVolumeAttachmentStatus successfully', function(done) {
        //uncomment below and update the code to test readVolumeAttachmentStatus
        //instance.readVolumeAttachmentStatus(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('replaceVolumeAttachmentStatus', function() {
      it('should call replaceVolumeAttachmentStatus successfully', function(done) {
        //uncomment below and update the code to test replaceVolumeAttachmentStatus
        //instance.replaceVolumeAttachmentStatus(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();

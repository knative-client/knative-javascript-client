...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1HorizontalPodAutoscalerList();
  });
  ...
  describe('V1HorizontalPodAutoscalerList', function() {
    it('should create an instance of V1HorizontalPodAutoscalerList', function() {
      // uncomment below and update the code to test V1HorizontalPodAutoscalerList

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1SecretVolumeSource();
  });
  ...
  describe('V1SecretVolumeSource', function() {
    it('should create an instance of V1SecretVolumeSource', function() {
      // uncomment below and update the code to test V1SecretVolumeSource
      //var instane = new KubernetesJsClient.V1SecretVolumeSource();
      //expect(instance).to.be.a(KubernetesJsClient.V1SecretVolumeSource);
    });

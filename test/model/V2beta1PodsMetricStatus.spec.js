...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V2beta1PodsMetricStatus();
  });
  ...
  describe('V2beta1PodsMetricStatus', function() {
    it('should create an instance of V2beta1PodsMetricStatus', function() {
      // uncomment below and update the code to test V2beta1PodsMetricStatus
      //var instane = new KubernetesJsClient.V2beta1PodsMetricStatus();
      //expect(instance).to.be.a(KubernetesJsClient.V2beta1PodsMetricStatus);
    });

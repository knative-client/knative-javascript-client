...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1SubjectRulesReviewStatus();
  });
  ...
  describe('V1SubjectRulesReviewStatus', function() {
    it('should create an instance of V1SubjectRulesReviewStatus', function() {
      // uncomment below and update the code to test V1SubjectRulesReviewStatus
      //var instane = new KubernetesJsClient.V1SubjectRulesReviewStatus();
      //expect(instance).to.be.a(KubernetesJsClient.V1SubjectRulesReviewStatus);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V2beta1HorizontalPodAutoscalerSpec();
  });
  ...
  describe('V2beta1HorizontalPodAutoscalerSpec', function() {
    it('should create an instance of V2beta1HorizontalPodAutoscalerSpec', function() {
      // uncomment below and update the code to test V2beta1HorizontalPodAutoscalerSpec
      //var instane = new KubernetesJsClient.V2beta1HorizontalPodAutoscalerSpec();
      //expect(instance).to.be.a(KubernetesJsClient.V2beta1HorizontalPodAutoscalerSpec);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1PodTemplateList();
  });
  ...
  describe('V1PodTemplateList', function() {
    it('should create an instance of V1PodTemplateList', function() {
      // uncomment below and update the code to test V1PodTemplateList

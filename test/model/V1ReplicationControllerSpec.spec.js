...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1ReplicationControllerSpec();
  });
  ...
  describe('V1ReplicationControllerSpec', function() {
    it('should create an instance of V1ReplicationControllerSpec', function() {
      // uncomment below and update the code to test V1ReplicationControllerSpec
      //var instane = new KubernetesJsClient.V1ReplicationControllerSpec();
      //expect(instance).to.be.a(KubernetesJsClient.V1ReplicationControllerSpec);
    });

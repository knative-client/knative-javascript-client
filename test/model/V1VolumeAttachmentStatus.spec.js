...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1VolumeAttachmentStatus();
  });
  ...
  describe('V1VolumeAttachmentStatus', function() {
    it('should create an instance of V1VolumeAttachmentStatus', function() {
      // uncomment below and update the code to test V1VolumeAttachmentStatus
      //var instane = new KubernetesJsClient.V1VolumeAttachmentStatus();
      //expect(instance).to.be.a(KubernetesJsClient.V1VolumeAttachmentStatus);
    });

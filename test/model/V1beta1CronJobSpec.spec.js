...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1beta1CronJobSpec();
  });
  ...
  describe('V1beta1CronJobSpec', function() {
    it('should create an instance of V1beta1CronJobSpec', function() {
      // uncomment below and update the code to test V1beta1CronJobSpec
      //var instane = new KubernetesJsClient.V1beta1CronJobSpec();
      //expect(instance).to.be.a(KubernetesJsClient.V1beta1CronJobSpec);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1beta1ReplicaSet();
  });
  ...
  describe('V1beta1ReplicaSet', function() {
    it('should create an instance of V1beta1ReplicaSet', function() {
      // uncomment below and update the code to test V1beta1ReplicaSet

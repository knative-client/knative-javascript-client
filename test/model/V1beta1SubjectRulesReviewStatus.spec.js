...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1beta1SubjectRulesReviewStatus();
  });
  ...
  describe('V1beta1SubjectRulesReviewStatus', function() {
    it('should create an instance of V1beta1SubjectRulesReviewStatus', function() {
      // uncomment below and update the code to test V1beta1SubjectRulesReviewStatus
      //var instane = new KubernetesJsClient.V1beta1SubjectRulesReviewStatus();
      //expect(instance).to.be.a(KubernetesJsClient.V1beta1SubjectRulesReviewStatus);
    });

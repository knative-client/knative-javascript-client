...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V2beta1ObjectMetricStatus();
  });
  ...
  describe('V2beta1ObjectMetricStatus', function() {
    it('should create an instance of V2beta1ObjectMetricStatus', function() {
      // uncomment below and update the code to test V2beta1ObjectMetricStatus
      //var instane = new KubernetesJsClient.V2beta1ObjectMetricStatus();
      //expect(instance).to.be.a(KubernetesJsClient.V2beta1ObjectMetricStatus);
    });

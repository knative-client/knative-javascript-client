...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V2beta2HorizontalPodAutoscalerSpec();
  });
  ...
  describe('V2beta2HorizontalPodAutoscalerSpec', function() {
    it('should create an instance of V2beta2HorizontalPodAutoscalerSpec', function() {
      // uncomment below and update the code to test V2beta2HorizontalPodAutoscalerSpec
      //var instane = new KubernetesJsClient.V2beta2HorizontalPodAutoscalerSpec();
      //expect(instance).to.be.a(KubernetesJsClient.V2beta2HorizontalPodAutoscalerSpec);
    });

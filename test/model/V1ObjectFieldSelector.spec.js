...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1ObjectFieldSelector();
  });
  ...
  describe('V1ObjectFieldSelector', function() {
    it('should create an instance of V1ObjectFieldSelector', function() {
      // uncomment below and update the code to test V1ObjectFieldSelector

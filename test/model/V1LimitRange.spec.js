...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1LimitRange();
  });
  ...
  describe('V1LimitRange', function() {
    it('should create an instance of V1LimitRange', function() {
      // uncomment below and update the code to test V1LimitRange

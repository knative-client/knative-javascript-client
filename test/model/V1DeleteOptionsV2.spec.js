...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1DeleteOptionsV2();
  });
  ...
  describe('V1DeleteOptionsV2', function() {
    it('should create an instance of V1DeleteOptionsV2', function() {
      // uncomment below and update the code to test V1DeleteOptionsV2
      //var instane = new KubernetesJsClient.V1DeleteOptionsV2();
      //expect(instance).to.be.a(KubernetesJsClient.V1DeleteOptionsV2);
    });

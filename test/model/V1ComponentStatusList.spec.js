...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1ComponentStatusList();
  });
  ...
  describe('V1ComponentStatusList', function() {
    it('should create an instance of V1ComponentStatusList', function() {
      // uncomment below and update the code to test V1ComponentStatusList

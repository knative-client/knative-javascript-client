...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1StorageOSPersistentVolumeSource();
  });
  ...
  describe('V1StorageOSPersistentVolumeSource', function() {
    it('should create an instance of V1StorageOSPersistentVolumeSource', function() {
      // uncomment below and update the code to test V1StorageOSPersistentVolumeSource
      //var instane = new KubernetesJsClient.V1StorageOSPersistentVolumeSource();
      //expect(instance).to.be.a(KubernetesJsClient.V1StorageOSPersistentVolumeSource);
    });

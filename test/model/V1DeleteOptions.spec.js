...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1DeleteOptions();
  });
  ...
  describe('V1DeleteOptions', function() {
    it('should create an instance of V1DeleteOptions', function() {
      // uncomment below and update the code to test V1DeleteOptions
      //var instane = new KubernetesJsClient.V1DeleteOptions();
      //expect(instance).to.be.a(KubernetesJsClient.V1DeleteOptions);
    });

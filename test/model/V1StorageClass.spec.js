...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1StorageClass();
  });
  ...
  describe('V1StorageClass', function() {
    it('should create an instance of V1StorageClass', function() {
      // uncomment below and update the code to test V1StorageClass
      //var instane = new KubernetesJsClient.V1StorageClass();
      //expect(instance).to.be.a(KubernetesJsClient.V1StorageClass);
    });

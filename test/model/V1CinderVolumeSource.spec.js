...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1CinderVolumeSource();
  });
  ...
  describe('V1CinderVolumeSource', function() {
    it('should create an instance of V1CinderVolumeSource', function() {
      // uncomment below and update the code to test V1CinderVolumeSource
      //var instane = new KubernetesJsClient.V1CinderVolumeSource();
      //expect(instance).to.be.a(KubernetesJsClient.V1CinderVolumeSource);
    });

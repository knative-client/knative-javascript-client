...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1PodAffinity();
  });
  ...
  describe('V1PodAffinity', function() {
    it('should create an instance of V1PodAffinity', function() {
      // uncomment below and update the code to test V1PodAffinity
      //var instane = new KubernetesJsClient.V1PodAffinity();
      //expect(instance).to.be.a(KubernetesJsClient.V1PodAffinity);
    });

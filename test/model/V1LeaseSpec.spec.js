...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1LeaseSpec();
  });
  ...
  describe('V1LeaseSpec', function() {
    it('should create an instance of V1LeaseSpec', function() {
      // uncomment below and update the code to test V1LeaseSpec
      //var instane = new KubernetesJsClient.V1LeaseSpec();
      //expect(instance).to.be.a(KubernetesJsClient.V1LeaseSpec);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1DeploymentSpec();
  });
  ...
  describe('V1DeploymentSpec', function() {
    it('should create an instance of V1DeploymentSpec', function() {
      // uncomment below and update the code to test V1DeploymentSpec
      //var instane = new KubernetesJsClient.V1DeploymentSpec();
      //expect(instance).to.be.a(KubernetesJsClient.V1DeploymentSpec);
    });

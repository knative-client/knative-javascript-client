...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V2beta1MetricSpec();
  });
  ...
  describe('V2beta1MetricSpec', function() {
    it('should create an instance of V2beta1MetricSpec', function() {
      // uncomment below and update the code to test V2beta1MetricSpec
      //var instane = new KubernetesJsClient.V2beta1MetricSpec();
      //expect(instance).to.be.a(KubernetesJsClient.V2beta1MetricSpec);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1PodAntiAffinity();
  });
  ...
  describe('V1PodAntiAffinity', function() {
    it('should create an instance of V1PodAntiAffinity', function() {
      // uncomment below and update the code to test V1PodAntiAffinity
      //var instane = new KubernetesJsClient.V1PodAntiAffinity();
      //expect(instance).to.be.a(KubernetesJsClient.V1PodAntiAffinity);
    });

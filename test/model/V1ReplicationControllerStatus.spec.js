...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1ReplicationControllerStatus();
  });
  ...
  describe('V1ReplicationControllerStatus', function() {
    it('should create an instance of V1ReplicationControllerStatus', function() {
      // uncomment below and update the code to test V1ReplicationControllerStatus
      //var instane = new KubernetesJsClient.V1ReplicationControllerStatus();
      //expect(instance).to.be.a(KubernetesJsClient.V1ReplicationControllerStatus);
    });

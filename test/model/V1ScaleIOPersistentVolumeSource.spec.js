...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1ScaleIOPersistentVolumeSource();
  });
  ...
  describe('V1ScaleIOPersistentVolumeSource', function() {
    it('should create an instance of V1ScaleIOPersistentVolumeSource', function() {
      // uncomment below and update the code to test V1ScaleIOPersistentVolumeSource
      //var instane = new KubernetesJsClient.V1ScaleIOPersistentVolumeSource();
      //expect(instance).to.be.a(KubernetesJsClient.V1ScaleIOPersistentVolumeSource);
    });

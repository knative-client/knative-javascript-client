...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1NodeCondition();
  });
  ...
  describe('V1NodeCondition', function() {
    it('should create an instance of V1NodeCondition', function() {
      // uncomment below and update the code to test V1NodeCondition
      //var instane = new KubernetesJsClient.V1NodeCondition();
      //expect(instance).to.be.a(KubernetesJsClient.V1NodeCondition);
    });

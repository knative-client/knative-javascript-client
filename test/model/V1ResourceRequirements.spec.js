...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1ResourceRequirements();
  });
  ...
  describe('V1ResourceRequirements', function() {
    it('should create an instance of V1ResourceRequirements', function() {
      // uncomment below and update the code to test V1ResourceRequirements

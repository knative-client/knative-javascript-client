...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1beta1SubjectAccessReviewSpec();
  });
  ...
  describe('V1beta1SubjectAccessReviewSpec', function() {
    it('should create an instance of V1beta1SubjectAccessReviewSpec', function() {
      // uncomment below and update the code to test V1beta1SubjectAccessReviewSpec
      //var instane = new KubernetesJsClient.V1beta1SubjectAccessReviewSpec();
      //expect(instance).to.be.a(KubernetesJsClient.V1beta1SubjectAccessReviewSpec);
    });

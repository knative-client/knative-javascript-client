...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1beta1ResourceAttributes();
  });
  ...
  describe('V1beta1ResourceAttributes', function() {
    it('should create an instance of V1beta1ResourceAttributes', function() {
      // uncomment below and update the code to test V1beta1ResourceAttributes
      //var instane = new KubernetesJsClient.V1beta1ResourceAttributes();
      //expect(instance).to.be.a(KubernetesJsClient.V1beta1ResourceAttributes);
    });

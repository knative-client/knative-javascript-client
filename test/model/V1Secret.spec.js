...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1Secret();
  });
  ...
  describe('V1Secret', function() {
    it('should create an instance of V1Secret', function() {
      // uncomment below and update the code to test V1Secret
      //var instane = new KubernetesJsClient.V1Secret();
      //expect(instance).to.be.a(KubernetesJsClient.V1Secret);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V2beta1MetricStatus();
  });
  ...
  describe('V2beta1MetricStatus', function() {
    it('should create an instance of V2beta1MetricStatus', function() {
      // uncomment below and update the code to test V2beta1MetricStatus
      //var instane = new KubernetesJsClient.V2beta1MetricStatus();
      //expect(instance).to.be.a(KubernetesJsClient.V2beta1MetricStatus);
    });

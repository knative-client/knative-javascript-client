...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1DaemonSetSpec();
  });
  ...
  describe('V1DaemonSetSpec', function() {
    it('should create an instance of V1DaemonSetSpec', function() {
      // uncomment below and update the code to test V1DaemonSetSpec
      //var instane = new KubernetesJsClient.V1DaemonSetSpec();
      //expect(instance).to.be.a(KubernetesJsClient.V1DaemonSetSpec);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1ConfigMapList();
  });
  ...
  describe('V1ConfigMapList', function() {
    it('should create an instance of V1ConfigMapList', function() {
      // uncomment below and update the code to test V1ConfigMapList

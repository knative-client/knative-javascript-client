...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1beta1SelfSubjectAccessReviewSpec();
  });
  ...
  describe('V1beta1SelfSubjectAccessReviewSpec', function() {
    it('should create an instance of V1beta1SelfSubjectAccessReviewSpec', function() {
      // uncomment below and update the code to test V1beta1SelfSubjectAccessReviewSpec

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1Handler();
  });
  ...
  describe('V1Handler', function() {
    it('should create an instance of V1Handler', function() {
      // uncomment below and update the code to test V1Handler
      //var instane = new KubernetesJsClient.V1Handler();
      //expect(instance).to.be.a(KubernetesJsClient.V1Handler);
    });

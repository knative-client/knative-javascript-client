...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1ServerAddressByClientCIDR();
  });
  ...
  describe('V1ServerAddressByClientCIDR', function() {
    it('should create an instance of V1ServerAddressByClientCIDR', function() {
      // uncomment below and update the code to test V1ServerAddressByClientCIDR
      //var instane = new KubernetesJsClient.V1ServerAddressByClientCIDR();

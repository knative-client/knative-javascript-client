...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V2beta2HorizontalPodAutoscalerStatus();
  });
  ...
  describe('V2beta2HorizontalPodAutoscalerStatus', function() {
    it('should create an instance of V2beta2HorizontalPodAutoscalerStatus', function() {
      // uncomment below and update the code to test V2beta2HorizontalPodAutoscalerStatus
      //var instane = new KubernetesJsClient.V2beta2HorizontalPodAutoscalerStatus();
      //expect(instance).to.be.a(KubernetesJsClient.V2beta2HorizontalPodAutoscalerStatus);
    });

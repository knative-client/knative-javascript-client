...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1ClusterRole();
  });
  ...
  describe('V1ClusterRole', function() {
    it('should create an instance of V1ClusterRole', function() {
      // uncomment below and update the code to test V1ClusterRole
      //var instane = new KubernetesJsClient.V1ClusterRole();
      //expect(instance).to.be.a(KubernetesJsClient.V1ClusterRole);
    });

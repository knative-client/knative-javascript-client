...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1beta2ReplicaSetStatus();
  });
  ...
  describe('V1beta2ReplicaSetStatus', function() {
    it('should create an instance of V1beta2ReplicaSetStatus', function() {
      // uncomment below and update the code to test V1beta2ReplicaSetStatus
      //var instane = new KubernetesJsClient.V1beta2ReplicaSetStatus();
      //expect(instance).to.be.a(KubernetesJsClient.V1beta2ReplicaSetStatus);
    });

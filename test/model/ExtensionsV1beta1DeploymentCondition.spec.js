...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.ExtensionsV1beta1DeploymentCondition();
  });
  ...
  describe('ExtensionsV1beta1DeploymentCondition', function() {
    it('should create an instance of ExtensionsV1beta1DeploymentCondition', function() {
      // uncomment below and update the code to test ExtensionsV1beta1DeploymentCondition
      //var instane = new KubernetesJsClient.ExtensionsV1beta1DeploymentCondition();

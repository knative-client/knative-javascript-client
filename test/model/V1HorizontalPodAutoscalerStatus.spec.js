...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1HorizontalPodAutoscalerStatus();
  });
  ...
  describe('V1HorizontalPodAutoscalerStatus', function() {
    it('should create an instance of V1HorizontalPodAutoscalerStatus', function() {
      // uncomment below and update the code to test V1HorizontalPodAutoscalerStatus

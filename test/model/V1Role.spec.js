...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1Role();
  });
  ...
  describe('V1Role', function() {
    it('should create an instance of V1Role', function() {
      // uncomment below and update the code to test V1Role
      //var instane = new KubernetesJsClient.V1Role();
      //expect(instance).to.be.a(KubernetesJsClient.V1Role);
    });

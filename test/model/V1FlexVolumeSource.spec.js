...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1FlexVolumeSource();
  });
  ...
  describe('V1FlexVolumeSource', function() {
    it('should create an instance of V1FlexVolumeSource', function() {
      ...
      //var instane = new KubernetesJsClient.V1FlexVolumeSource();
      //expect(instance).to.be.a(KubernetesJsClient.V1FlexVolumeSource);
    });

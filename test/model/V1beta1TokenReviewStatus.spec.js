...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1beta1TokenReviewStatus();
  });
  ...
  describe('V1beta1TokenReviewStatus', function() {
    it('should create an instance of V1beta1TokenReviewStatus', function() {
      // uncomment below and update the code to test V1beta1TokenReviewStatus
      //var instane = new KubernetesJsClient.V1beta1TokenReviewStatus();

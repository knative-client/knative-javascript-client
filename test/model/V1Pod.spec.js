...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1Pod();
  });
  ...
  describe('V1Pod', function() {
    it('should create an instance of V1Pod', function() {
      // uncomment below and update the code to test V1Pod
      //var instane = new KubernetesJsClient.V1Pod();
      //expect(instance).to.be.a(KubernetesJsClient.V1Pod);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1ReplicaSetSpec();
  });
  ...
  describe('V1ReplicaSetSpec', function() {
    it('should create an instance of V1ReplicaSetSpec', function() {
      // uncomment below and update the code to test V1ReplicaSetSpec
      //var instane = new KubernetesJsClient.V1ReplicaSetSpec();
      //expect(instance).to.be.a(KubernetesJsClient.V1ReplicaSetSpec);
    });

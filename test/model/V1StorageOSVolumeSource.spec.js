...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1StorageOSVolumeSource();
  });
  ...
  describe('V1StorageOSVolumeSource', function() {
    it('should create an instance of V1StorageOSVolumeSource', function() {
      // uncomment below and update the code to test V1StorageOSVolumeSource
      //var instane = new KubernetesJsClient.V1StorageOSVolumeSource();
      //expect(instance).to.be.a(KubernetesJsClient.V1StorageOSVolumeSource);
    });

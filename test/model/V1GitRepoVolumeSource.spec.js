...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1GitRepoVolumeSource();
  });
  ...
  describe('V1GitRepoVolumeSource', function() {
    it('should create an instance of V1GitRepoVolumeSource', function() {
      // uncomment below and update the code to test V1GitRepoVolumeSource
      //var instane = new KubernetesJsClient.V1GitRepoVolumeSource();
      //expect(instance).to.be.a(KubernetesJsClient.V1GitRepoVolumeSource);
    });

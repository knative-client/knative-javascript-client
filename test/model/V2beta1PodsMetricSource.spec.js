...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V2beta1PodsMetricSource();
  });
  ...
  describe('V2beta1PodsMetricSource', function() {
    it('should create an instance of V2beta1PodsMetricSource', function() {
      // uncomment below and update the code to test V2beta1PodsMetricSource
      //var instane = new KubernetesJsClient.V2beta1PodsMetricSource();
      //expect(instance).to.be.a(KubernetesJsClient.V2beta1PodsMetricSource);
    });

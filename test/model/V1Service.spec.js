...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1Service();
  });
  ...
  describe('V1Service', function() {
    it('should create an instance of V1Service', function() {
      // uncomment below and update the code to test V1Service
      //var instane = new KubernetesJsClient.V1Service();
      //expect(instance).to.be.a(KubernetesJsClient.V1Service);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1CephFSPersistentVolumeSource();
  });
  ...
  describe('V1CephFSPersistentVolumeSource', function() {
    it('should create an instance of V1CephFSPersistentVolumeSource', function() {
      // uncomment below and update the code to test V1CephFSPersistentVolumeSource
      //var instane = new KubernetesJsClient.V1CephFSPersistentVolumeSource();
      //expect(instance).to.be.a(KubernetesJsClient.V1CephFSPersistentVolumeSource);
    });

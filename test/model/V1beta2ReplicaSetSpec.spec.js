...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1beta2ReplicaSetSpec();
  });
  ...
  describe('V1beta2ReplicaSetSpec', function() {
    it('should create an instance of V1beta2ReplicaSetSpec', function() {
      // uncomment below and update the code to test V1beta2ReplicaSetSpec
      //var instane = new KubernetesJsClient.V1beta2ReplicaSetSpec();
      //expect(instance).to.be.a(KubernetesJsClient.V1beta2ReplicaSetSpec);
    });

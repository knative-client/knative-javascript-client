...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1beta2DaemonSetSpec();
  });
  ...
  describe('V1beta2DaemonSetSpec', function() {
    it('should create an instance of V1beta2DaemonSetSpec', function() {
      // uncomment below and update the code to test V1beta2DaemonSetSpec
      //var instane = new KubernetesJsClient.V1beta2DaemonSetSpec();
      //expect(instance).to.be.a(KubernetesJsClient.V1beta2DaemonSetSpec);
    });

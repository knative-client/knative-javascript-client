...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1beta1ReplicaSetStatus();
  });
  ...
  describe('V1beta1ReplicaSetStatus', function() {
    it('should create an instance of V1beta1ReplicaSetStatus', function() {
      // uncomment below and update the code to test V1beta1ReplicaSetStatus
      //var instane = new KubernetesJsClient.V1beta1ReplicaSetStatus();
      //expect(instance).to.be.a(KubernetesJsClient.V1beta1ReplicaSetStatus);
    });

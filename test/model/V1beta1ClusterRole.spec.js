...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1beta1ClusterRole();
  });
  ...
  describe('V1beta1ClusterRole', function() {
    it('should create an instance of V1beta1ClusterRole', function() {
      // uncomment below and update the code to test V1beta1ClusterRole
      //var instane = new KubernetesJsClient.V1beta1ClusterRole();
      //expect(instance).to.be.a(KubernetesJsClient.V1beta1ClusterRole);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1ListMeta();
  });
  ...
  describe('V1ListMeta', function() {
    it('should create an instance of V1ListMeta', function() {
      // uncomment below and update the code to test V1ListMeta
      //var instane = new KubernetesJsClient.V1ListMeta();
      //expect(instance).to.be.a(KubernetesJsClient.V1ListMeta);
    });

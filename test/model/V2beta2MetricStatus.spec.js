...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V2beta2MetricStatus();
  });
  ...
  describe('V2beta2MetricStatus', function() {
    it('should create an instance of V2beta2MetricStatus', function() {
      // uncomment below and update the code to test V2beta2MetricStatus
      //var instane = new KubernetesJsClient.V2beta2MetricStatus();
      //expect(instance).to.be.a(KubernetesJsClient.V2beta2MetricStatus);
    });

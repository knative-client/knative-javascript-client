...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1beta2DeploymentSpec();
  });
  ...
  describe('V1beta2DeploymentSpec', function() {
    it('should create an instance of V1beta2DeploymentSpec', function() {
      // uncomment below and update the code to test V1beta2DeploymentSpec
      //var instane = new KubernetesJsClient.V1beta2DeploymentSpec();
      //expect(instance).to.be.a(KubernetesJsClient.V1beta2DeploymentSpec);
    });
